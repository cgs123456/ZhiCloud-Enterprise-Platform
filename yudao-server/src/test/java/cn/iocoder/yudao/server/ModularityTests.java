...
class ModularityTests {
     ...
     * <p>ApplicationModules.of(YudaoServerApplication.class) 会扫描所有带 package-info.java 的模块，
    ...
    void verifyModularity() {
        ApplicationModules.of(YudaoServerApplication.class).verify();
    }
    ...
    void writeDocumentation() {
        new Documenter(ApplicationModules.of(YudaoServerApplication.class))
