 ...
 * </ol>
 *
 * <p>通过 {@code yudao.airag.reranker.enabled=true} 控制是否启用（Bean 在 {@code AiragConfiguration} 中注册）。
 *
 * @author yudao
 */
@Slf4j
public class RerankerServiceImpl implements RerankerService {
    ...
    @Value("${yudao.airag.reranker.model-path:bge-reranker-base}")
    private String modelPath;

    @Value("${yudao.airag.reranker.fallback-to-simple:true}")
