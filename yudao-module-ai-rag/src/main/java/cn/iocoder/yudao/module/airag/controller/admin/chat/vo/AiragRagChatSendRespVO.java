package cn.iocoder.yudao.module.airag.controller.admin.chat.vo;
...
public class AiragRagChatSendRespVO {
    ...
    @Schema(description = "回答内容", required = true, example = "您可以通过 application.yaml 中的 yudao.tenant.* 进行配置...")
