...
public class StabilityAiImageModelTests {
    ...
    private final String apiKey = System.getenv("STABILITYAI_API_KEY");

    private final StabilityAiImageModel imageModel = new StabilityAiImageModel(
            new StabilityAiApi(apiKey) // 密钥
    );

    @Test
    @Disabled
    public void testCall() {
        Assumptions.assumeTrue(apiKey != null, "跳过：未配置 STABILITYAI_API_KEY 环境变量");
        // 准备参数
