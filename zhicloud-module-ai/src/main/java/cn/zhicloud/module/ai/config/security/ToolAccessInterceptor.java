 ...
 *
 * <h3>引用参考</h3>
 * <p>实现风格参考 {@link cn.zhicloud.module.ai.mcp.tools.McpToolSecurityAspect}，
...
@Aspect
@Component
@ConditionalOnProperty(prefix = "zhicloud.ai.security.tool-access", name = "whitelist-enabled", havingValue = "true")
@Slf4j
