package cn.zhicloud.module.ai.controller.admin.write;
...
import cn.zhicloud.module.ai.controller.admin.write.vo.AiWriteRespVO;
import cn.zhicloud.module.ai.dal.dataobject.write.AiWriteDO;
import cn.zhicloud.module.ai.service.write.AiWriteService;
...
public class AiWriteController {
    ...
    @PreAuthorize("@ss.hasPermission('ai:write:create')")
