...
import static cn.zhicloud.framework.common.exception.enums.GlobalErrorCodeConstants.FORBIDDEN;
import static cn.zhicloud.framework.common.exception.enums.GlobalErrorCodeConstants.UNAUTHORIZED;
 ...
 *     MCP 请求经过 zhicloud-security 的 TokenAuthenticationFilter 后会注入登录用户）
...
public class McpToolSecurityAspect {
     ...
     */
    @Around("@annotation(cn.zhicloud.module.ai.mcp.tools.McpToolRequiresPermission)")
