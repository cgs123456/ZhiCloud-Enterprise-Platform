 ...
 *  2. 调用 {@link cn.zhicloud.framework.security.core.service.SecurityFrameworkService#hasPermission(String)}
 *     判断是否拥有指定权限
 *  3. 未登录或权限不足，抛出 {@link cn.zhicloud.framework.common.exception.ServiceException}，
 *     返回 403 错误码给 MCP 客户端
 *
 * 使用方式：
 * <pre>
 ...
 * </pre>
 *
 * 注意：与 zhicloud 后端 RBAC 权限码保持一致，方便后台统一管理。
 *
 * @author 智云
 */
