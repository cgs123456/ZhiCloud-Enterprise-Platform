package cn.zhicloud.module.ai.service.chat;
...
import cn.zhicloud.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.zhicloud.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.zhicloud.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.zhicloud.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.zhicloud.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.zhicloud.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.zhicloud.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.zhicloud.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.zhicloud.module.ai.dal.dataobject.model.AiModelDO;
import cn.zhicloud.module.ai.dal.dataobject.model.AiToolDO;
import cn.zhicloud.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.zhicloud.module.ai.enums.ErrorCodeConstants;
...
import cn.zhicloud.module.ai.service.knowledge.AiKnowledgeDocumentService;
...
import cn.zhicloud.module.ai.service.model.AiChatRoleService;
...
import cn.zhicloud.module.ai.util.FileTypeUtils;
...
import static cn.zhicloud.framework.common.pojo.CommonResult.error;
...
import static cn.zhicloud.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.zhicloud.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 zhicloud.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 zhicloud.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
    ...
    public Flux<CommonResult<AiChatMessageSendRespVO>> sendChatMessageStream(AiChatMessageSendReqVO sendReqVO,
        ...
        return streamResponse.map(chunk -> {
            ...
            TenantUtils.executeIgnore(() -> {
                ...
                // P1: SSE 背压控制，防止慢客户端导致 OOM
                .onBackpressureBuffer(64, BufferOverflowStrategy.DROP_OLDEST);
    }
