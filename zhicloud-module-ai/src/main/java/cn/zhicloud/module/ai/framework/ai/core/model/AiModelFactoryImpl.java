package cn.zhicloud.module.ai.framework.ai.core.model;
...
import cn.zhicloud.framework.common.util.spring.SpringUtils;
import cn.zhicloud.module.ai.enums.model.AiPlatformEnum;
import cn.zhicloud.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.zhicloud.module.ai.framework.ai.config.ZhiCloudAiProperties;
...
import cn.zhicloud.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.zhicloud.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
import cn.zhicloud.module.ai.util.AiUtils;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String rawApiKey, String rawUrl) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            ZhiCloudAiProperties.Midjourney properties = SpringUtil.getBean(ZhiCloudAiProperties.class)
                    .getMidjourney();
    ...
    private ChatModel buildYiYanChatModel(String apiKey) {
        ZhiCloudAiProperties.YiYan properties = new ZhiCloudAiProperties.YiYan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(ZhiCloudAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        ZhiCloudAiProperties.DouBao properties = new ZhiCloudAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(ZhiCloudAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        ZhiCloudAiProperties.HunYuan properties = new ZhiCloudAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(ZhiCloudAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        ZhiCloudAiProperties.SiliconFlow properties = new ZhiCloudAiProperties.SiliconFlow()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildSiliconFlowChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#zhiPuChatClient(ZhiCloudAiProperties)}
     */
    private ZhiPuChatModel buildZhiPuChatModel(String apiKey, String url) {
        ZhiCloudAiProperties.ZhiPu properties = new ZhiCloudAiProperties.ZhiPu()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildZhiPuChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#miniMaxChatClient(ZhiCloudAiProperties)}
     */
    private MiniMaxChatModel buildMiniMaxChatModel(String apiKey, String url) {
        ZhiCloudAiProperties.MiniMax properties = new ZhiCloudAiProperties.MiniMax()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildMiniMaxChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#moonshotChatClient(ZhiCloudAiProperties)}
     */
    private MoonshotChatModel buildMoonshotChatModel(String apiKey, String url) {
        ZhiCloudAiProperties.Moonshot properties = new ZhiCloudAiProperties.Moonshot()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildMoonshotChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#stepFunChatClient(ZhiCloudAiProperties)}
     */
    private StepFunChatModel buildStepFunChatModel(String apiKey, String url) {
        ZhiCloudAiProperties.StepFun properties = new ZhiCloudAiProperties.StepFun()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildStepFunChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(ZhiCloudAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String apiKey) {
        ZhiCloudAiProperties.XingHuo properties = new ZhiCloudAiProperties.XingHuo()
                .setApiKey(apiKey).setModel(XingHuoChatModel.MODEL_DEFAULT);
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(ZhiCloudAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        ZhiCloudAiProperties.BaiChuan properties = new ZhiCloudAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(ZhiCloudAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        ZhiCloudAiProperties.Gemini properties = SpringUtil.getBean(ZhiCloudAiProperties.class)
    ...
    private GrokChatModel buildGrokChatModel(String apiKey, String url) {
        ZhiCloudAiProperties.Grok properties = new ZhiCloudAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
