package cn.zhicloud.module.ai.controller.admin.model.vo.chatRole;
...
public class AiChatRoleSaveMyReqVO {
    ...
    @Schema(description = "角色头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zhicloud.cn/1.png")
