...
import cn.iocoder.yudao.module.oa.controller.admin.reimburse.vo.OaReimburseItemVO;
...
import cn.iocoder.yudao.module.oa.dal.mysql.reimburse.OaReimburseItemMapper;
...
import static cn.iocoder.yudao.module.oa.enums.ErrorCodeConstants.OA_REIMBURSE_NO_DUPLICATE;
import static cn.iocoder.yudao.module.oa.enums.ErrorCodeConstants.OA_REIMBURSE_NOT_EXISTS;
import static cn.iocoder.yudao.module.oa.enums.ErrorCodeConstants.OA_REIMBURSE_STATUS_INVALID;
...
public class OaReimburseServiceImpl implements OaReimburseService {
    ...
    private void saveItems(Long reimburseId, List<OaReimburseItemVO> items) {
        ...
        for (OaReimburseItemVO item : items) {
            ...
            reimburseItemMapper.insert(itemDO);
