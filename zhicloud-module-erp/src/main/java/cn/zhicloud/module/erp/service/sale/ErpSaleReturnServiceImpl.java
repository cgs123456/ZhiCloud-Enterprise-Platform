...
import cn.zhicloud.module.erp.controller.admin.sale.vo.returns.ErpSaleReturnPageReqVO;
import cn.zhicloud.module.erp.controller.admin.sale.vo.returns.ErpSaleReturnSaveReqVO;
...
import cn.zhicloud.module.erp.dal.dataobject.sale.ErpSaleReturnDO;
import cn.zhicloud.module.erp.dal.dataobject.sale.ErpSaleReturnItemDO;
import cn.zhicloud.module.erp.dal.mysql.sale.ErpSaleReturnItemMapper;
import cn.zhicloud.module.erp.dal.mysql.sale.ErpSaleReturnMapper;
...
public class ErpSaleReturnServiceImpl implements ErpSaleReturnService {
    ...
    public void updateSaleReturnStatus(Long id, Integer status) {
        ...
        saleReturnItems.forEach(saleReturnItem -> {
            List<Long> key = List.of(saleReturnItem.getProductId(), saleReturnItem.getWarehouseId());
            ...
            firstItemIdMap.putIfAbsent(key, saleReturnItem.getId());
        });
        mergedCountMap.forEach((key, count) -> stockRecordService.createStockRecord(new ErpStockRecordCreateReqBO(
                ...
                bizType, id, firstItemIdMap.get(key), saleReturn.getNo())));
    }
