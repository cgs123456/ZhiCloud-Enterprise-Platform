...
import cn.zhicloud.module.erp.dal.mysql.purchase.evaluation.ErpSupplierEvaluationItemMapper;
import cn.zhicloud.module.erp.dal.mysql.purchase.evaluation.ErpSupplierEvaluationMapper;
import cn.zhicloud.module.erp.enums.ErpAuditStatus;
import cn.zhicloud.module.erp.service.purchase.ErpPurchaseInService;
import cn.zhicloud.module.erp.service.purchase.ErpPurchaseOrderService;
import cn.zhicloud.module.erp.service.purchase.ErpPurchaseReturnService;
...
import static cn.zhicloud.module.erp.enums.ErrorCodeConstants.SUPPLIER_EVALUATION_NOT_EXISTS;
import static cn.zhicloud.module.erp.enums.ErrorCodeConstants.SUPPLIER_EVALUATION_PERIOD_DUPLICATE;
...
public class ErpSupplierEvaluationServiceImpl implements ErpSupplierEvaluationService {
    ...
    private List<ErpPurchaseOrderDO> queryPurchaseOrders(Long supplierId, LocalDateTime start, LocalDateTime end) {
        ...
        cn.zhicloud.module.erp.controller.admin.purchase.vo.order.ErpPurchaseOrderPageReqVO pageReqVO =
                new cn.zhicloud.module.erp.controller.admin.purchase.vo.order.ErpPurchaseOrderPageReqVO();
        pageReqVO.setSupplierId(supplierId);
        pageReqVO.setStatus(ErpAuditStatus.APPROVE.getStatus());
