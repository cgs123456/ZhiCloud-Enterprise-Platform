...
import cn.zhicloud.module.erp.enums.finance.ErpPeriodCloseStatusEnum;
...
import cn.zhicloud.module.erp.controller.admin.finance.vo.period.ErpPeriodCloseResultRespVO;
import cn.zhicloud.module.erp.controller.admin.finance.vo.period.ErpPeriodPageReqVO;
import cn.zhicloud.module.erp.controller.admin.finance.vo.period.ErpPeriodSaveReqVO;
...
import cn.zhicloud.module.erp.dal.dataobject.purchase.ErpPurchaseInDO;
import cn.zhicloud.module.erp.dal.dataobject.sale.ErpSaleOutDO;
import cn.zhicloud.module.erp.dal.dataobject.stock.ErpStockInDO;
import cn.zhicloud.module.erp.dal.dataobject.stock.ErpStockOutDO;
import cn.zhicloud.module.erp.dal.dataobject.finance.ErpFinancePaymentDO;
import cn.zhicloud.module.erp.dal.dataobject.finance.ErpFinanceReceiptDO;
import cn.zhicloud.module.erp.dal.mysql.finance.*;
import cn.zhicloud.module.erp.dal.mysql.purchase.ErpPurchaseInMapper;
import cn.zhicloud.module.erp.dal.mysql.sale.ErpSaleOutMapper;
import cn.zhicloud.module.erp.dal.mysql.stock.ErpStockInMapper;
import cn.zhicloud.module.erp.dal.mysql.stock.ErpStockOutMapper;
...
public class ErpPeriodServiceImpl implements ErpPeriodService {
    ...
    public PageResult<ErpPeriodDO> getPeriodPage(ErpPeriodPageReqVO pageReqVO) {
        return periodMapper.selectPage(pageReqVO,
                new cn.zhicloud.framework.mybatis.core.query.LambdaQueryWrapperX<ErpPeriodDO>()
    ...
    private Integer countUnapproved(ErpPurchaseInMapper mapper, LocalDateTime[] timeRange) {
        return safeCount("erp_purchase_in", () -> mapper.selectCount(
                new cn.zhicloud.framework.mybatis.core.query.LambdaQueryWrapperX<ErpPurchaseInDO>()
    ...
    private Integer countUnapproved(ErpSaleOutMapper mapper, LocalDateTime[] timeRange) {
        return safeCount("erp_sale_out", () -> mapper.selectCount(
                new cn.zhicloud.framework.mybatis.core.query.LambdaQueryWrapperX<ErpSaleOutDO>()
    ...
    private Integer countUnapproved(ErpStockInMapper mapper, LocalDateTime[] timeRange) {
        return safeCount("erp_stock_in", () -> mapper.selectCount(
                new cn.zhicloud.framework.mybatis.core.query.LambdaQueryWrapperX<ErpStockInDO>()
    ...
    private Integer countUnapproved(ErpStockOutMapper mapper, LocalDateTime[] timeRange) {
        return safeCount("erp_stock_out", () -> mapper.selectCount(
                new cn.zhicloud.framework.mybatis.core.query.LambdaQueryWrapperX<ErpStockOutDO>()
    ...
    private Integer countUnapproved(ErpFinancePaymentMapper mapper, LocalDateTime[] timeRange) {
        return safeCount("erp_finance_payment", () -> mapper.selectCount(
                new cn.zhicloud.framework.mybatis.core.query.LambdaQueryWrapperX<ErpFinancePaymentDO>()
    ...
    private Integer countUnapproved(ErpFinanceReceiptMapper mapper, LocalDateTime[] timeRange) {
        return safeCount("erp_finance_receipt", () -> mapper.selectCount(
                new cn.zhicloud.framework.mybatis.core.query.LambdaQueryWrapperX<ErpFinanceReceiptDO>()
    ...
    private String getCurrentUser() {
        ...
        try {
            return cn.zhicloud.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname();
        } catch (Exception e) {
            return "system";
        }
    }
