...
import cn.zhicloud.module.erp.dal.mysql.purchase.ErpPurchaseOrderItemMapper;
...
public class ErpPurchaseOrderServiceImpl implements ErpPurchaseOrderService {
    ...
    private void calculateTotalPrice(ErpPurchaseOrderDO purchaseOrder, List<ErpPurchaseOrderItemDO> purchaseOrderItems) {
        ...
        // P0-8：多币种折算
        applyMultiCurrency(purchaseOrder);
    }
     ...
     * @param order 采购订单
     */
    private void applyMultiCurrency(ErpPurchaseOrderDO order) {
