...
import cn.zhicloud.module.erp.controller.admin.purchase.vo.in.ErpPurchaseInPageReqVO;
import cn.zhicloud.module.erp.controller.admin.purchase.vo.in.ErpPurchaseInSaveReqVO;
...
import cn.zhicloud.module.erp.dal.dataobject.purchase.ErpPurchaseInItemDO;
import cn.zhicloud.module.erp.dal.dataobject.purchase.ErpPurchaseOrderDO;
import cn.zhicloud.module.erp.dal.mysql.purchase.ErpPurchaseInItemMapper;
...
public class ErpPurchaseInServiceImpl implements ErpPurchaseInService {
    ...
    public void updatePurchaseInStatus(Long id, Integer status) {
        ...
        purchaseInItems.forEach(purchaseInItem -> {
            List<Long> key = List.of(purchaseInItem.getProductId(), purchaseInItem.getWarehouseId());
            ...
            firstItemIdMap.putIfAbsent(key, purchaseInItem.getId());
        });
        mergedCountMap.forEach((key, count) -> stockRecordService.createStockRecord(new ErpStockRecordCreateReqBO(
                ...
                bizType, id, firstItemIdMap.get(key), purchaseIn.getNo())));
    }
