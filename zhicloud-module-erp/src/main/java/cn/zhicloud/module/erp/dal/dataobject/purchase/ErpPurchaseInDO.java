package cn.zhicloud.module.erp.dal.dataobject.purchase;
...
public class ErpPurchaseInDO extends BaseDO {
     ...
     * 入库状态
     *
     * 枚举 {@link cn.zhicloud.module.erp.enums.ErpAuditStatus}
     */
     ...
     * 已支付金额，单位：元
     *
     * 目的：和 {@link cn.zhicloud.module.erp.dal.dataobject.finance.ErpFinancePaymentDO} 结合，记录已支付金额
     */
     ...
     * 币种编号
     *
     * 关联 {@link cn.zhicloud.module.erp.dal.dataobject.finance.ErpCurrencyDO#getId()}
     * 为空时使用租户本位币
     */
    private Long currencyId;
    /**
     * 汇率（外币 → 本位币），冗余记录单据生成时的汇率
     */
