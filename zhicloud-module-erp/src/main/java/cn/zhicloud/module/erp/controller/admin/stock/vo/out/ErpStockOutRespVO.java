package cn.zhicloud.module.erp.controller.admin.stock.vo.out;
...
import static cn.zhicloud.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "智云")
    @ExcelProperty("客户名称")
    ...
    @Schema(description = "附件 URL", example = "https://www.zhicloud.cn/1.doc")
