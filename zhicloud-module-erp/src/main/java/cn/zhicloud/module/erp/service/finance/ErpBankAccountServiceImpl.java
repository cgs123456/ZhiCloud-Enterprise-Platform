...
import cn.zhicloud.module.erp.controller.admin.finance.vo.bankaccount.ErpBankAccountSaveReqVO;
import cn.zhicloud.module.erp.dal.dataobject.finance.ErpBankAccountDO;
import cn.zhicloud.module.erp.dal.mysql.finance.ErpBankAccountMapper;
...
import static cn.zhicloud.module.erp.enums.ErrorCodeConstants.BANK_ACCOUNT_NOT_ENABLE;
import static cn.zhicloud.module.erp.enums.ErrorCodeConstants.BANK_ACCOUNT_NOT_EXISTS;
...
public class ErpBankAccountServiceImpl implements ErpBankAccountService {
    ...
    public ErpBankAccountDO validateBankAccount(Long id) {
        ...
        if (cn.zhicloud.framework.common.enums.CommonStatusEnum.isDisable(bankAccount.getStatus())) {
