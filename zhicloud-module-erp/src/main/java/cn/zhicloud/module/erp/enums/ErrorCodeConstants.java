package cn.zhicloud.module.erp.enums;
...
ErrorCode PURCHASE_ORDER_ITEM_RETURN_FAIL_IN_EXCEED = new ErrorCode(1_030_101_009, "采购订单项({})超过最大允许退货数量({})");
    ...
    ErrorCode FIXED_ASSET_BATCH_DEPRECIATION_PARTIAL_FAIL = new ErrorCode(1_030_707_013, "部分资产折旧计提失败，失败资产：{}");
    ...
    ErrorCode GOLDEN_TAX_NOT_ENABLED = new ErrorCode(1_040_940_000, "金税接口未启用，请在配置中开启（zhicloud.erp.golden-tax.enabled=true）");
