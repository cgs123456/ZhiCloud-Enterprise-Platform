package cn.zhicloud.module.promotion.controller.admin.combination.vo.recrod;
...
public class CombinationRecordBaseVO {
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zhicloud.cn/xxx.jpg")
