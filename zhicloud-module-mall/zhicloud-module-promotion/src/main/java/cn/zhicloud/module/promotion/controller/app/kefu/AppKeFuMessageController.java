package cn.zhicloud.module.promotion.controller.app.kefu;
...
import cn.zhicloud.module.promotion.service.kefu.KeFuMessageService;
...
public class AppKeFuMessageController {
    ...
    @PreAuthorize("@ss.hasPermission('promotion:kefu-message:create')")
