package cn.zhicloud.module.trade.controller.admin.config;

import cn.zhicloud.framework.common.pojo.CommonResult;
import cn.zhicloud.module.trade.controller.admin.config.vo.TradeConfigRespVO;
import cn.zhicloud.module.trade.controller.admin.config.vo.TradeConfigSaveReqVO;
import cn.zhicloud.module.trade.convert.config.TradeConfigConvert;
...
public class TradeConfigController {
    ...
    @Value("${zhicloud.tencent-lbs-key}")
