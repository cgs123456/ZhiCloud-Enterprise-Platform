package cn.zhicloud.module.trade.controller.admin.delivery.vo.pickup;
...
public class DeliveryPickUpStoreBaseVO {
    ...
    @Schema(description = "门店 logo", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zhicloud.cn/1.png")
