package cn.zhicloud.module.trade.controller.app.aftersale.vo;
...
public class AppAfterSaleRespVO {
    ...
    @Schema(description = "商品图片", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zhicloud.cn/01.jpg")
