...
import cn.zhicloud.framework.common.util.string.StrUtils;
import cn.zhicloud.framework.dict.core.DictFrameworkUtils;
import cn.zhicloud.framework.ip.core.utils.AreaUtils;
...
import cn.zhicloud.module.pay.enums.DictTypeConstants;
import cn.zhicloud.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.zhicloud.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.zhicloud.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.zhicloud.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.zhicloud.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.zhicloud.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.zhicloud.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.zhicloud.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.zhicloud.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.zhicloud.module.trade.controller.admin.order.vo.*;
import cn.zhicloud.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.zhicloud.module.trade.controller.app.order.vo.*;
import cn.zhicloud.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.zhicloud.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.zhicloud.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import cn.zhicloud.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.zhicloud.module.trade.framework.order.config.TradeOrderProperties;
import cn.zhicloud.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.zhicloud.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/zhicloudcode/zhicloud-mall-uniapp/issues/ICY7SJ
