package cn.zhicloud.module.product.controller.app.spu.vo;
...
public class AppProductSpuDetailRespVO {
    ...
    @Schema(description = "商品名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "智云")
    private String name;
    ...
    public static class Sku {
        ...
        @Schema(description = "图片地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zhicloud.cn/xx.png")
        private String picUrl;
