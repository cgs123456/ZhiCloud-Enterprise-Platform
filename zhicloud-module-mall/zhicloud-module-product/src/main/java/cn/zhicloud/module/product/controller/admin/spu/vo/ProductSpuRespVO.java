package cn.zhicloud.module.product.controller.admin.spu.vo;
...
import cn.zhicloud.framework.excel.core.convert.MoneyConvert;
import cn.zhicloud.module.product.enums.DictTypeConstants;
...
public class ProductSpuRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zhicloud.cn/xx.png")
    @ExcelProperty("商品封面图")
    private String picUrl;

    @Schema(description = "商品轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.zhicloud.cn/xx.png, https://www.zhicloud.cn/xxx.png]")
