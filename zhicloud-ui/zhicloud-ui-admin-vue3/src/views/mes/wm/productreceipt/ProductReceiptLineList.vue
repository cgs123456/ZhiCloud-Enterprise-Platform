...
import { WmProductRecptLineApi as WmProductReceiptLineApi, WmProductRecptLineVO as WmProductReceiptLineVO } from '@/api/mes/wm/productreceipt/line'
...
const getList = async () => {
  ...
  try {
    ...
    const data = await WmProductReceiptLineApi.getProductRecptLinePage(queryParams)
...
const handleDelete = async (id: number) => {
  try {
    ...
    await WmProductReceiptLineApi.deleteProductRecptLine(id)
...
const openForm = async (type: string, id?: number) => {
  ...
  if (id) {
    ...
    try {
      formData.value = await WmProductReceiptLineApi.getProductRecptLine(id)
    } finally {
...
const submitForm = async () => {
  ...
  try {
    ...
    if (lineFormType.value === 'create') {
      await WmProductReceiptLineApi.createProductRecptLine(data)
      message.success(t('common.createSuccess'))
    } else {
      await WmProductReceiptLineApi.updateProductRecptLine(data)
