<template>
  <doc-alert title="【仓库】产品产出、产品入库" url="https://doc.zhicloud.cn/mes/wm/product-in/" />
...
const getList = async () => {
  loading.value = true
  try {
    const data = await WmProductReceiptApi.getProductRecptPage(queryParams)
...
const handleCancel = async (id: number) => {
  try {
    ...
    await WmProductReceiptApi.cancelProductRecpt(id)
...
const handleDelete = async (id: number) => {
  try {
    ...
    await WmProductReceiptApi.deleteProductRecpt(id)
...
const handleExport = async () => {
  try {
    ...
    const data = await WmProductReceiptApi.exportProductRecpt(queryParams)
