<template>
  <Dialog v-model="dialogVisible" title="办理转正" width="760px">
    ...
    >
      ...
      <el-row :gutter="18">
        <el-col :span="12">
          <el-form-item label="转正后部门" prop="newDeptId">
            <DeptSelect v-model="formData.newDeptId" class="!w-1/1" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="转正后岗位" prop="newPostName">
            <el-input
      ...
      <el-row :gutter="18">
        <el-col :span="12">
          <el-form-item label="转正后职级" prop="newPostLevel">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="转正后上级" prop="newLeaderEmployeeId">
            <HrmEmployeeSelect
      ...
      <el-form-item label="转正后工作地点" prop="newWorkAddress">
        <el-input
    ...
    <template #footer>
      <el-button type="primary" :loading="formLoading" @click="submitForm">确认转正</el-button>
...
import type { HrmEmployeeRegularReqVO, HrmEmployeeVO } from '@/api/hrm/employee'
...
const formData = ref<HrmEmployeeRegularReqVO>({}) // 表单数据
...
async function submitForm() {
  ...
  try {
    await EmployeeApi.regularEmployee(formData.value)
