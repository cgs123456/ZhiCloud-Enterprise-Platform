export default {
  ...
  login: {
    ...
    brandEyebrow: 'Enterprise Digital Platform',
    brandTitle: 'One platform,\nfor every business flow',
    brandMessage:
      'ERP, MES, WMS, QMS, CRM, HR, OA and TMS out of the box, with workflow approval and AI retrieval built in.',
    capabilityDomainTitle: '8 business domains',
    capabilityDomainDesc: 'Finance, production, inventory and quality in one place',
    capabilityWorkflowTitle: 'Workflow engine',
    capabilityWorkflowDesc: 'Configurable approvals, forms and integrations',
    capabilityAiTitle: 'AI built in',
    capabilityAiDesc: 'Knowledge retrieval and multi-agent orchestration',
