export default {
  ...
  login: {
    ...
    brandEyebrow: '企业数字化平台',
    brandTitle: '一个平台，\n承载企业全部业务流',
    brandMessage:
      'ERP、MES、WMS、QMS、CRM、HR、OA、TMS 八大业务域开箱即用，内置流程审批与 AI 检索能力。',
    capabilityDomainTitle: '八大业务域',
    capabilityDomainDesc: '财务、生产、仓储、质量一体化协同',
    capabilityWorkflowTitle: '流程引擎',
    capabilityWorkflowDesc: '审批、表单、集成灵活配置',
    capabilityAiTitle: 'AI 能力',
    capabilityAiDesc: '知识库检索、多智能体编排',
    tenantname: '租户名称',
    username: '用户名',
    password: '密码',
    code: '验证码',
