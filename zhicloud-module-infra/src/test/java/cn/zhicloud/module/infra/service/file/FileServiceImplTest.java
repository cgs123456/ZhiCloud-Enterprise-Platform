...
import cn.zhicloud.framework.test.core.util.AssertUtils;
import cn.zhicloud.module.infra.controller.admin.file.vo.file.FileCreateReqVO;
...
import cn.zhicloud.module.infra.dal.mysql.file.FileMapper;
...
import static cn.zhicloud.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
import static cn.zhicloud.module.infra.enums.ErrorCodeConstants.FILE_PATH_INVALID;
...
public class FileServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileByPresignedPath_success() {
        ...
        FileCreateReqVO reqVO = randomPojo(FileCreateReqVO.class, o -> {
            ...
            o.setName("test.jpg");
            o.setUrl("https://www.zhicloud.cn/test.jpg?token=123");
        });
        ...
        assertEquals("https://www.zhicloud.cn/test.jpg", file.getUrl());
    }
