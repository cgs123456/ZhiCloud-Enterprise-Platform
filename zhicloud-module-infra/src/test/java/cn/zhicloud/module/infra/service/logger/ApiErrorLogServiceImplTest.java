package cn.zhicloud.module.infra.service.logger;
...
import cn.zhicloud.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.zhicloud.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.zhicloud.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.zhicloud.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.zhicloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.zhicloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("zhicloud-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("zhicloud-test");
