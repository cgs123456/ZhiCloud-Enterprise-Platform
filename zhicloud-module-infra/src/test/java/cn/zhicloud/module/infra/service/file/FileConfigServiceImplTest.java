package cn.zhicloud.module.infra.service.file;
...
import cn.zhicloud.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import cn.zhicloud.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import cn.zhicloud.module.infra.dal.dataobject.file.FileConfigDO;
import cn.zhicloud.module.infra.dal.mysql.file.FileConfigMapper;
import cn.zhicloud.module.infra.framework.file.core.client.FileClient;
import cn.zhicloud.module.infra.framework.file.core.client.FileClientConfig;
import cn.zhicloud.module.infra.framework.file.core.client.FileClientFactory;
import cn.zhicloud.module.infra.framework.file.core.client.local.LocalFileClient;
import cn.zhicloud.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import cn.zhicloud.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static cn.zhicloud.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static cn.zhicloud.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        ...
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai")
                .put("domain", "https://www.zhicloud.cn").build();
        ...
        assertEquals("https://www.zhicloud.cn", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/yunai").setDomain("https://www.zhicloud.cn")));
        ...
        FileConfigSaveReqVO reqVO = randomPojo(FileConfigSaveReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai2")
                    .put("domain", "https://doc.zhicloud.cn").build();
            o.setConfig(config);
        });
        ...
        assertEquals("https://doc.zhicloud.cn", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("智云")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://www.zhicloud.cn");

        // 调用，并断言
        assertEquals("https://www.zhicloud.cn", fileConfigService.testFileConfig(id));
    }
