package cn.zhicloud.module.infra.framework.file.core.utils;
...
public class FileTypeUtils {
    ...
    public static void writeAttachment(HttpServletResponse response, String filename, byte[] content) throws IOException {
        ...
        if (isImage(mineType)) {
            // 安全加固：SVG 可内嵌 JS 脚本，inline 展示存在存储型 XSS 风险，
            // 强制以附件下载，并禁止浏览器 MIME 嗅探
            if ("image/svg+xml".equalsIgnoreCase(mineType)) {
