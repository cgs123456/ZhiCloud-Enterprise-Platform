...
import cn.zhicloud.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import cn.zhicloud.module.infra.enums.codegen.CodegenColumnListConditionEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link cn.zhicloud.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://www.zhicloud.cn");
            return;
        }
        // reason
