package cn.zhicloud.module.infra.controller.admin.codegen;
...
import cn.zhicloud.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.zhicloud.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.zhicloud.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import cn.zhicloud.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import cn.zhicloud.module.infra.convert.codegen.CodegenConvert;
...
import cn.zhicloud.module.infra.service.codegen.CodegenService;
...
import static cn.zhicloud.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "zhicloud"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "智云")
    })
