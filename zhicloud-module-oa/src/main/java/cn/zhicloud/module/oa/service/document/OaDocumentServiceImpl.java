package cn.zhicloud.module.oa.service.document;
...
import cn.zhicloud.module.oa.controller.admin.document.vo.OaDocumentAttachmentVO;
import cn.zhicloud.module.oa.controller.admin.document.vo.OaDocumentPageReqVO;
import cn.zhicloud.module.oa.controller.admin.document.vo.OaDocumentSaveReqVO;
...
import cn.zhicloud.module.oa.dal.mysql.document.OaDocumentAttachmentMapper;
...
import static cn.zhicloud.module.oa.enums.ErrorCodeConstants.OA_DOCUMENT_ARCHIVE_NO_REQUIRED;
import static cn.zhicloud.module.oa.enums.ErrorCodeConstants.OA_DOCUMENT_NO_DUPLICATE;
import static cn.zhicloud.module.oa.enums.ErrorCodeConstants.OA_DOCUMENT_NOT_EXISTS;
import static cn.zhicloud.module.oa.enums.ErrorCodeConstants.OA_DOCUMENT_REVIEW_OPINION_REQUIRED;
import static cn.zhicloud.module.oa.enums.ErrorCodeConstants.OA_DOCUMENT_SIGN_OPINION_REQUIRED;
import static cn.zhicloud.module.oa.enums.ErrorCodeConstants.OA_DOCUMENT_STATUS_INVALID;
...
public class OaDocumentServiceImpl implements OaDocumentService {
    ...
    private void saveAttachments(Long documentId, List<OaDocumentAttachmentVO> attachments) {
        ...
        List<OaDocumentAttachmentDO> attachmentDOs = new ArrayList<>(attachments.size());
        for (OaDocumentAttachmentVO attachment : attachments) {
            ...
            attachmentDOs.add(attachmentDO);
        }
        documentAttachmentMapper.insertBatch(attachmentDOs);
    }
