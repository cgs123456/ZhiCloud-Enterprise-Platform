package cn.zhicloud.module.system.service.user;
...
import cn.zhicloud.framework.common.util.collection.ArrayUtils;
...
import cn.zhicloud.module.infra.api.config.ConfigApi;
import cn.zhicloud.module.infra.api.file.FileApi;
...
import cn.zhicloud.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.zhicloud.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.zhicloud.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.zhicloud.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.zhicloud.module.system.dal.dataobject.dept.DeptDO;
import cn.zhicloud.module.system.dal.dataobject.dept.PostDO;
import cn.zhicloud.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.zhicloud.module.system.dal.mysql.dept.UserPostMapper;
import cn.zhicloud.module.system.dal.mysql.user.AdminUserMapper;
import cn.zhicloud.module.system.enums.common.SexEnum;
import cn.zhicloud.module.system.mq.producer.user.AdminUserProducer;
...
import cn.zhicloud.module.system.service.tenant.TenantService;
...
import static cn.zhicloud.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("zhicloudyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("zhicloudyuanma");
        ...
        assertEquals("zhicloudyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("zhicloudyuanma"))).thenReturn("java");
