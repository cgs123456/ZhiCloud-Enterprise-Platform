package cn.zhicloud.module.system.service.tenant;

import cn.zhicloud.framework.common.enums.CommonStatusEnum;
import cn.zhicloud.framework.common.pojo.PageResult;
import cn.zhicloud.framework.tenant.config.TenantProperties;
...
import cn.zhicloud.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.zhicloud.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.zhicloud.module.system.dal.dataobject.permission.MenuDO;
import cn.zhicloud.module.system.dal.dataobject.permission.RoleDO;
import cn.zhicloud.module.system.dal.dataobject.tenant.TenantDO;
import cn.zhicloud.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.zhicloud.module.system.dal.mysql.tenant.TenantMapper;
import cn.zhicloud.module.system.enums.permission.RoleCodeEnum;
import cn.zhicloud.module.system.enums.permission.RoleTypeEnum;
import cn.zhicloud.module.system.service.permission.MenuService;
...
import cn.zhicloud.module.system.service.tenant.handler.TenantInfoHandler;
import cn.zhicloud.module.system.service.tenant.handler.TenantMenuHandler;
...
import static cn.zhicloud.framework.common.util.collection.SetUtils.asSet;
import static cn.zhicloud.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.zhicloud.framework.common.util.date.LocalDateTimeUtils.buildTime;
...
import static cn.zhicloud.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("智云", user.getNickname());
        ...
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            ...
            o.setWebsites(singletonList("https://www.zhicloud.cn"));
            o.setUsername("yunai");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("智云"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("智云");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
    ...
    public void testGetTenantByWebsite() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsites(singletonList("https://www.zhicloud.cn")));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://www.zhicloud.cn");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
