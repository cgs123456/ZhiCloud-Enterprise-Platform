...
public interface AdminUserService {
     ...
     *
     * @param id 用户编号
     * @param totpSecret TOTP 密钥（明文，由 MyBatis EncryptTypeHandler 自动加密入库）
     * @param totpEnabled 是否启用
     */
    void updateUserTotp(Long id, String totpSecret, Boolean totpEnabled);
