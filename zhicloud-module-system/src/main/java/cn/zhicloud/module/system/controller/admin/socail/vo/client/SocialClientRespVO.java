package cn.zhicloud.module.system.controller.admin.socail.vo.client;
...
public class SocialClientRespVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "zhicloud商城")
    private String name;
