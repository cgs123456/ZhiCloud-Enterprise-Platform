...
import cn.zhicloud.module.system.enums.DictTypeConstants;
...
public class OperateLogRespVO implements VO {
    ...
    @Schema(description = "操作明细", example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从智云改成源码。")
    ...
    @Schema(description = "前一条日志的 hash（Hash 链式审计）", example = "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855")
    private String prevHash;

    @Schema(description = "本条日志的 hash（Hash 链式审计）", example = "9e1d3a4f2c8b5a7d6f0e4c3b2a190c8d7e6f5a4b3c2d1e0f9a8b7c6d5e4f3a2b1")
