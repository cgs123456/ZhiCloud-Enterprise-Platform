...
import cn.zhicloud.module.system.controller.admin.tenant.vo.tenant.TenantRespVO;
...
public class TenantController {
    ...
    @Parameter(name = "website", description = "域名", required = true, example = "www.zhicloud.cn")
