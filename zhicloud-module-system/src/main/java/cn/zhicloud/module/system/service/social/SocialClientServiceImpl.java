package cn.zhicloud.module.system.service.social;
...
import cn.zhicloud.framework.common.util.cache.CacheUtils;
import cn.zhicloud.framework.common.util.http.HttpUtils;
import cn.zhicloud.framework.common.util.object.BeanUtils;
import cn.zhicloud.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.zhicloud.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.zhicloud.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.zhicloud.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.zhicloud.module.system.dal.dataobject.social.SocialClientDO;
import cn.zhicloud.module.system.dal.mysql.social.SocialClientMapper;
import cn.zhicloud.module.system.dal.redis.RedisKeyConstants;
import cn.zhicloud.module.system.enums.social.SocialTypeEnum;
import cn.zhicloud.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.zhicloud.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.zhicloud.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${zhicloud.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${zhicloud.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/zhicloud-cloud/pulls/230
