package cn.zhicloud.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode AUTH_LOGIN_REQUIRE_TOTP = new ErrorCode(1_002_000_009, "登录失败，需要双因素认证");
    ErrorCode AUTH_TOTP_CODE_ERROR = new ErrorCode(1_002_000_010, "TOTP 验证码不正确");
    ErrorCode AUTH_TOTP_NOT_ENABLED = new ErrorCode(1_002_000_011, "用户未启用 TOTP 双因素认证");
    ErrorCode AUTH_TOTP_ALREADY_ENABLED = new ErrorCode(1_002_000_012, "用户已启用 TOTP 双因素认证");
    ErrorCode AUTH_TOTP_SECRET_NOT_EXISTS = new ErrorCode(1_002_000_013, "TOTP 密钥不存在，请先绑定");
    ErrorCode AUTH_TOTP_DISABLED = new ErrorCode(1_002_000_014, "TOTP 双因素认证功能已关闭");
    ErrorCode AUTH_TOTP_CODE_USED = new ErrorCode(1_002_000_015, "TOTP 验证码已使用，请等待下一个时间周期");
