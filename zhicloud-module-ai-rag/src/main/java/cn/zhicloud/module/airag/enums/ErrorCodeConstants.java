package cn.zhicloud.module.airag.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode DOCUMENT_URL_BLOCKED = new ErrorCode(1_041_001_005, "文档地址不安全（SSRF 防护），已拒绝访问：{}");

    // ========== RAG 检索 1-041-002-000 ==========
    ErrorCode RAG_VECTOR_STORE_NOT_READY = new ErrorCode(1_041_002_000, "向量存储未启用，请先配置 zhicloud.airag.enabled=true 并部署 PostgreSQL + pgvector");
