package cn.zhicloud.module.mes.controller.admin.dv.repair;
...
import cn.zhicloud.module.mes.controller.admin.dv.repair.vo.MesDvRepairPageReqVO;
import cn.zhicloud.module.mes.controller.admin.dv.repair.vo.MesDvRepairRespVO;
import cn.zhicloud.module.mes.controller.admin.dv.repair.vo.MesDvRepairSaveReqVO;
import cn.zhicloud.module.mes.dal.dataobject.dv.machinery.MesDvMachineryDO;
import cn.zhicloud.module.mes.dal.dataobject.dv.repair.MesDvRepairDO;
...
public class MesDvRepairController {
    ...
    @PreAuthorize("@ss.hasPermission('mes:dv-repair:update')")
    public CommonResult<Boolean> confirmRepair(@Valid @RequestBody cn.zhicloud.module.mes.controller.admin.dv.repair.vo.MesDvRepairConfirmReqVO confirmReqVO) {
