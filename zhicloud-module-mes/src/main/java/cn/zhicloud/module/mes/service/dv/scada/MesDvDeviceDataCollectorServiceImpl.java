...
import cn.zhicloud.module.mes.dal.mysql.dv.scada.MesDvScadaConfigMapper;
import cn.zhicloud.module.mes.enums.dv.MesDvScadaProtocolTypeEnum;
...
import static cn.zhicloud.module.mes.enums.ErrorCodeConstants.DV_DEVICE_DATA_COLLECT_CONFIG_DISABLED;
import static cn.zhicloud.module.mes.enums.ErrorCodeConstants.DV_DEVICE_DATA_COLLECT_CONFIG_NOT_EXISTS;
...
public class MesDvDeviceDataCollectorServiceImpl implements MesDvDeviceDataCollectorService {
     ...
     * IoT 模块对外 API（可选）
     *
     * <p>当前 {@code zhicloud-module-iot} 未启用，此处为 null。
