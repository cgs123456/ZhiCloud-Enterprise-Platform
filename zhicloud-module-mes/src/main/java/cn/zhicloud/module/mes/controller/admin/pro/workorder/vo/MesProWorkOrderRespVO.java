package cn.zhicloud.module.mes.controller.admin.pro.workorder.vo;
...
public class MesProWorkOrderRespVO {
    ...
    @Schema(description = "工单优先级（APS 排产排序用）：1=高/2=中/3=低", example = "2")
    @ExcelProperty(value = "工单优先级", converter = DictConvert.class)
