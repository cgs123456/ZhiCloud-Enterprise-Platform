...
public interface DictTypeConstants {
    ...
    String MES_PRO_APS_PLAN_PRIORITY = "mes_pro_aps_plan_priority"; // MES 排产计划优先级
    String MES_PRO_APS_PLAN_STATUS = "mes_pro_aps_plan_status"; // MES 排产计划状态
    String MES_PRO_MRP_PLAN_STATUS = "mes_pro_mrp_plan_status"; // MES MRP 计划状态
    String MES_PRO_REWORK_TYPE = "mes_rework_type"; // MES 返工类型
    String MES_PRO_REWORK_STATUS = "mes_rework_status"; // MES 返工状态
    String MES_DEFECT_TYPE = "mes_defect_type"; // MES 缺陷类型
    String MES_REPAIR_METHOD = "mes_repair_method"; // MES 处理方式
    ...
    // ========== 独立 BOM (BOM) ==========
    String MES_BOM_TYPE = "mes_bom_type"; // MES BOM 类型
}
