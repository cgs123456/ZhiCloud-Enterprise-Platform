...
import cn.zhicloud.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import cn.zhicloud.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import cn.zhicloud.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import cn.zhicloud.module.mes.enums.qc.MesQcCheckResultEnum;
...
import cn.zhicloud.module.mes.dal.dataobject.wm.salesnotice.MesWmSalesNoticeLineDO;
import cn.zhicloud.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public cn.zhicloud.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return cn.zhicloud.framework.common.pojo.PageResult.empty();
            }
