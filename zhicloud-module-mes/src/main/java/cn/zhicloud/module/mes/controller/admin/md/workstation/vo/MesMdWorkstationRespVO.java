package cn.zhicloud.module.mes.controller.admin.md.workstation.vo;
...
public class MesMdWorkstationRespVO {
    ...
    @Schema(description = "单位时间产能（件/小时，APS 排产时长估算用）", example = "100.00")
    @ExcelProperty("单位时间产能")
    private BigDecimal capacity;

    @Schema(description = "效率系数（1.0=标准，<1=降额，>1=增强）", example = "1.00")
    @ExcelProperty("效率系数")
