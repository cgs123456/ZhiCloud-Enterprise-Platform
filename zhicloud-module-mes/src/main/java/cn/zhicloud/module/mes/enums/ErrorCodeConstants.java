package cn.zhicloud.module.mes.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode DV_MACHINERY_TYPE_NOT_EXISTS = new ErrorCode(1_046_000_000, "设备类型不存在");
    ErrorCode DV_MACHINERY_TYPE_EXITS_CHILDREN = new ErrorCode(1_040_300_001, "存在子类型，无法删除");
    ErrorCode DV_MACHINERY_TYPE_PARENT_NOT_EXITS = new ErrorCode(1_046_000_001, "父级类型不存在");
    ErrorCode DV_MACHINERY_TYPE_PARENT_ERROR = new ErrorCode(1_046_000_002, "不能设置自己为父类型");
    ErrorCode DV_MACHINERY_TYPE_NAME_DUPLICATE = new ErrorCode(1_046_000_003, "同一父类型下已存在该名称");
    ErrorCode DV_MACHINERY_TYPE_CODE_DUPLICATE = new ErrorCode(1_046_000_004, "设备类型编码已存在");
    ErrorCode DV_MACHINERY_TYPE_PARENT_IS_CHILD = new ErrorCode(1_040_300_006, "不能设置自己的子类型为父类型");
    ErrorCode DV_MACHINERY_TYPE_HAS_MACHINERY = new ErrorCode(1_046_000_005, "该类型下存在设备，无法删除");
    ...
    // ========== MES 设备管理-OEE 设备综合效率（1-040-307-000） ==========
    ErrorCode DV_OEE_RECORD_NOT_EXISTS = new ErrorCode(1_040_307_000, "OEE 记录不存在");
    ErrorCode DV_OEE_MACHINERY_NOT_EXISTS = new ErrorCode(1_040_307_001, "OEE 计算的设备不存在");
    ErrorCode DV_OEE_PLAN_TIME_INVALID = new ErrorCode(1_040_307_002, "OEE 计划生产时间必须大于 0");
    ErrorCode DV_OEE_DATE_RANGE_INVALID = new ErrorCode(1_040_307_003, "OEE 查询开始时间必须早于结束时间");

    // ========== MES 设备管理-SCADA 设备配置（1-040-308-000） ==========
    ErrorCode DV_SCADA_CONFIG_NOT_EXISTS = new ErrorCode(1_040_308_000, "SCADA 设备配置不存在");
    ErrorCode DV_SCADA_CONFIG_MACHINERY_DUPLICATE = new ErrorCode(1_040_308_001, "该设备已存在 SCADA 配置，请勿重复添加");
    ErrorCode DV_SCADA_PROTOCOL_TYPE_INVALID = new ErrorCode(1_040_308_002, "不支持的 SCADA 协议类型");
    ErrorCode DV_SCADA_IOT_DEVICE_PK_REQUIRED = new ErrorCode(1_040_308_003, "IoT 设备 PK 不能为空");
    ErrorCode DV_SCADA_IOT_MODULE_NOT_ENABLED = new ErrorCode(1_040_308_004, "IoT 模块未启用，SCADA 实时数据不可用");

    // ========== MES 工具管理-工具类型（1-040-400-000） ==========
    ErrorCode TM_TOOL_TYPE_NOT_EXISTS = new ErrorCode(1_046_000_006, "工具类型不存在");
    ErrorCode TM_TOOL_TYPE_CODE_DUPLICATE = new ErrorCode(1_046_000_007, "工具类型编码已存在");
    ErrorCode TM_TOOL_TYPE_NAME_DUPLICATE = new ErrorCode(1_046_000_008, "工具类型名称已存在");
    ErrorCode TM_TOOL_TYPE_HAS_TOOL = new ErrorCode(1_046_000_009, "该工具类型下存在工具，无法删除");
    ErrorCode TM_TOOL_TYPE_HAS_WORKSTATION_TOOL = new ErrorCode(1_046_000_010, "该工具类型已被工作站工装资源引用，无法删除");
    ...
    ErrorCode PRO_PROCESS_CODE_EXISTS = new ErrorCode(1_046_000_011, "工序编码已存在");
    ErrorCode PRO_PROCESS_NAME_EXISTS = new ErrorCode(1_040_500_002, "工序名称已存在");
    ErrorCode PRO_PROCESS_USED_BY_ROUTE = new ErrorCode(1_046_000_012, "工序已被工艺路线引用，无法删除");
    ErrorCode PRO_PROCESS_IS_DISABLE = new ErrorCode(1_046_000_013, "工序已禁用");
    ...
    // ========== MES 生产管理-APS 排产计划（1-040-509-000） ==========
    ErrorCode PRO_APS_PLAN_NOT_EXISTS = new ErrorCode(1_040_509_000, "排产计划不存在");
    ErrorCode PRO_APS_PLAN_WORK_ORDER_EMPTY = new ErrorCode(1_040_509_001, "排产工单列表不能为空");
    ErrorCode PRO_APS_PLAN_NOT_CONFIRMED = new ErrorCode(1_040_509_002, "只有已确认状态的排产计划才能执行此操作");
    ErrorCode PRO_APS_PLAN_RESCHEDULE_TIME_INVALID = new ErrorCode(1_040_509_003, "重排产开始时间必须早于计划结束时间");
    ErrorCode PRO_APS_PLAN_WORKSTATION_EMPTY = new ErrorCode(1_040_509_004, "无可用工作 station，排产中止");
    ErrorCode PRO_APS_PLAN_ROUTE_PRODUCT_NOT_FOUND = new ErrorCode(1_040_509_005, "产品「{}」未配置工艺路线生产用时，无法精确估算排产时长");
    ErrorCode PRO_APS_PLAN_QUANTITY_INVALID = new ErrorCode(1_040_509_006, "工单「{}」生产数量无效，无法排产");
    ErrorCode PRO_APS_PLAN_DATE_RANGE_INVALID = new ErrorCode(1_040_509_007, "排产时间范围无效：开始时间必须早于结束时间");
    ErrorCode PRO_APS_PLAN_WORK_ORDER_DUPLICATE = new ErrorCode(1_040_509_008, "工单「{}」已存在排产计划，重复排产请先取消原计划");
    ErrorCode PRO_APS_PLAN_WORK_ORDER_STATUS_INVALID = new ErrorCode(1_040_509_009, "工单「{}」状态非「已确认」，不允许排产");
    ErrorCode PRO_APS_PLAN_CAPACITY_EXCEEDED = new ErrorCode(1_040_509_010, "工位「{}」产能负载超限，排产可能延后");

    // ========== MES 生产管理-MRP 物料需求计划（1-040-510-000） ==========
    ErrorCode PRO_MRP_PLAN_NOT_EXISTS = new ErrorCode(1_040_510_000, "MRP 计划不存在");
    ErrorCode PRO_MRP_PLAN_WORK_ORDER_EMPTY = new ErrorCode(1_046_000_015, "MRP 计算的生产工单不能为空");
    ErrorCode PRO_MRP_PLAN_NOT_DRAFT = new ErrorCode(1_046_000_016, "只有草稿状态的 MRP 计划才能执行计算");
    ErrorCode PRO_MRP_PLAN_NOT_CALCULATED = new ErrorCode(1_046_000_017, "只有已计算状态的 MRP 计划才能确认");

    // ========== MES 生产管理-返工工单（1-040-511-000） ==========
    // 注：原任务建议使用 1-040-700-000 段，但该段已被 WM_WAREHOUSE 占用，故改用 PRO 子域内 1-040-511-000 段以避免冲突
    ErrorCode PRO_REWORK_ORDER_NOT_EXISTS = new ErrorCode(1_040_511_000, "返工工单不存在");
    ErrorCode PRO_REWORK_ORDER_CODE_DUPLICATE = new ErrorCode(1_040_511_001, "返工工单编码已存在");
    ErrorCode PRO_REWORK_ORDER_STATUS_INVALID = new ErrorCode(1_040_511_002, "返工工单状态不正确，无法执行此操作");
    ErrorCode PRO_REWORK_ORDER_QUANTITY_INVALID = new ErrorCode(1_040_511_003, "返工数量超过原工单可返工数量");
    ErrorCode PRO_REWORK_ORDER_NOT_STARTABLE = new ErrorCode(1_040_511_004, "只有待返工状态的工单才能开工");
    ErrorCode PRO_REWORK_ORDER_NOT_COMPLETABLE = new ErrorCode(1_040_511_005, "只有返工中状态的工单才能完工，且所有明细需已处理");
    ErrorCode PRO_REWORK_DETAIL_NOT_EXISTS = new ErrorCode(1_040_511_100, "返工工单明细不存在");

    // ========== MES 生产管理-计件工资规则（1-040-516-000） ==========
    ErrorCode PRO_PIECEWORK_RULE_NOT_EXISTS = new ErrorCode(1_040_516_000, "计件工资规则不存在");
    ErrorCode PRO_PIECEWORK_RULE_NAME_DUPLICATE = new ErrorCode(1_040_516_001, "计件工资规则名称已存在");
    ErrorCode PRO_PIECEWORK_RULE_DATE_RANGE_INVALID = new ErrorCode(1_040_516_002, "计件工资规则生效日期必须早于失效日期");
    ErrorCode PRO_PIECEWORK_RULE_PRICE_INVALID = new ErrorCode(1_040_516_003, "计件单价必须大于等于 0");

    // ========== MES 生产管理-计件工资明细（1-040-517-000） ==========
    ErrorCode PRO_PIECEWORK_RECORD_NOT_EXISTS = new ErrorCode(1_040_517_000, "计件工资明细不存在");
    ErrorCode PRO_PIECEWORK_RECORD_FEEDBACK_DUPLICATE = new ErrorCode(1_040_517_001, "该报工单已生成计件明细，请勿重复生成");
    ErrorCode PRO_PIECEWORK_RULE_NOT_MATCHED = new ErrorCode(1_040_517_002, "未匹配到计件工资规则，无法生成计件明细");
    ErrorCode PRO_PIECEWORK_SUMMARY_PERIOD_INVALID = new ErrorCode(1_040_517_003, "汇总月份格式不正确，应为 yyyyMM");

    // ========== MES 质量管理-质检方案（1-040-600-000） ==========
    ErrorCode QC_TEMPLATE_NOT_EXISTS = new ErrorCode(1_040_600_000, "质检方案不存在");
    ErrorCode QC_TEMPLATE_CODE_DUPLICATE = new ErrorCode(1_046_000_014, "质检方案编号已存在");
    ...
    ErrorCode WM_WAREHOUSE_NOT_EXISTS = new ErrorCode(1_046_000_018, "仓库不存在");
    ErrorCode WM_WAREHOUSE_CODE_DUPLICATE = new ErrorCode(1_046_000_019, "仓库编码已存在");
    ...
    ErrorCode WM_PRODUCT_PRODUCE_QC_FAILED = new ErrorCode(1_040_709_005, "生产入库单关联工单的 QMS 终检未通过（检验不通过），禁止完工入库");
    ...
    ErrorCode WM_RETURN_ISSUE_NOT_EXISTS = new ErrorCode(1_046_000_021, "生产退料单不存在");
    ErrorCode WM_RETURN_ISSUE_STATUS_INVALID = new ErrorCode(1_046_000_022, "生产退料单状态不正确，无法执行该操作");
    ErrorCode WM_RETURN_ISSUE_NOT_PREPARE = new ErrorCode(1_046_000_023, "只有草稿状态的退料单才可操作");
    ErrorCode WM_RETURN_ISSUE_NOT_CONFIRMED = new ErrorCode(1_046_000_024, "只有待检验状态的退料单才可提交");
    ErrorCode WM_RETURN_ISSUE_NOT_APPROVING = new ErrorCode(1_046_000_025, "只有待上架状态的退料单才可入库上架");
    ErrorCode WM_RETURN_ISSUE_NOT_APPROVED = new ErrorCode(1_046_000_026, "只有待执行退料状态的退料单才可完成");
    ErrorCode WM_RETURN_ISSUE_NO_LINE = new ErrorCode(1_046_000_027, "生产退料单至少需要一条行数据");
    ErrorCode WM_RETURN_ISSUE_DETAIL_QUANTITY_MISMATCH = new ErrorCode(1_046_000_028, "退料单行数量与明细数量不一致");
    ErrorCode WM_RETURN_ISSUE_CANCEL_NOT_ALLOWED = new ErrorCode(1_046_000_029, "生产退料单已完成或已取消，无法取消");
    ErrorCode WM_RETURN_ISSUE_LINE_NOT_EXISTS = new ErrorCode(1_046_000_030, "生产退料单行不存在");
    ErrorCode WM_RETURN_ISSUE_DETAIL_NOT_EXISTS = new ErrorCode(1_046_000_031, "生产退料单明细不存在");
    ErrorCode WM_RETURN_ISSUE_DETAIL_QUANTITY_INVALID = new ErrorCode(1_046_000_032, "退料明细数量必须大于0");
    ErrorCode WM_RETURN_ISSUE_DETAIL_QUANTITY_EXCEED = new ErrorCode(1_046_000_033, "退料明细总数量不能超过退料单行数量");
    ...
    ErrorCode WM_RETURN_SALES_NOT_EXISTS = new ErrorCode(1_046_000_034, "销售退货单不存在");
    ErrorCode WM_RETURN_SALES_CODE_DUPLICATE = new ErrorCode(1_046_000_035, "销售退货单编码已存在");
    ErrorCode WM_RETURN_SALES_STATUS_NOT_PREPARE = new ErrorCode(1_046_000_036, "只有草稿状态才允许此操作");
    ErrorCode WM_RETURN_SALES_STATUS_NOT_APPROVING = new ErrorCode(1_046_000_037, "只有待执行状态才允许执行退货");
    ErrorCode WM_RETURN_SALES_STATUS_NOT_APPROVED = new ErrorCode(1_046_000_038, "只有待上架状态才允许执行上架");
    ErrorCode WM_RETURN_SALES_NO_LINE = new ErrorCode(1_046_000_039, "销售退货单至少需要一条行数据");
    ErrorCode WM_RETURN_SALES_DETAIL_QUANTITY_MISMATCH = new ErrorCode(1_046_000_040, "销售退货单行数量与明细数量不一致");
    ErrorCode WM_RETURN_SALES_CANCEL_NOT_ALLOWED = new ErrorCode(1_040_713_007, "销售退货单已完成或已取消，无法取消");
    ErrorCode WM_RETURN_SALES_LINE_NOT_EXISTS = new ErrorCode(1_046_000_041, "销售退货单行不存在");
    ErrorCode WM_RETURN_SALES_DETAIL_NOT_EXISTS = new ErrorCode(1_046_000_042, "销售退货单明细不存在");
    ...
    // ========== MES TPM 计划 1-040-512-000 ==========
    ErrorCode DV_TP_PLAN_NOT_EXISTS = new ErrorCode(1_040_512_000, "TPM 计划不存在");
    ErrorCode DV_TP_PLAN_NO_DUPLICATE = new ErrorCode(1_040_512_001, "TPM 计划编号已存在：{}");
    ErrorCode DV_TP_PLAN_STATUS_INVALID = new ErrorCode(1_040_512_002, "TPM 计划状态不正确，无法执行该操作");

    // ========== MES TPM 计划项目 1-040-513-000 ==========
    ErrorCode DV_TP_PLAN_ITEM_NOT_EXISTS = new ErrorCode(1_040_513_000, "TPM 计划项目不存在");

    // ========== MES TPM 执行记录 1-040-514-000 ==========
    ErrorCode DV_TP_RECORD_NOT_EXISTS = new ErrorCode(1_040_514_000, "TPM 执行记录不存在");

    // ========== MES TPM KPI 指标 1-040-515-000 ==========
    ErrorCode DV_TP_KPI_NOT_EXISTS = new ErrorCode(1_040_515_000, "TPM KPI 指标不存在");

    // ========== MES 基础数据-独立BOM（1-040-111-000） ==========
    ErrorCode MD_BOM_NOT_EXISTS = new ErrorCode(1_040_111_000, "BOM 不存在");
    ErrorCode MD_BOM_NO_DUPLICATE = new ErrorCode(1_040_111_001, "BOM 编号已存在：{}");
    ErrorCode MD_BOM_EXPLODE_CIRCULAR = new ErrorCode(1_040_111_002, "BOM 递归展开检测到循环依赖，产品编号：{}");
    ErrorCode MD_BOM_EXPLODE_DEPTH_EXCEEDED = new ErrorCode(1_040_111_003, "BOM 递归展开超过最大深度 10 层");
    ErrorCode MD_BOM_NOT_EXISTS_FOR_PRODUCT = new ErrorCode(1_040_111_004, "产品「{}」未配置生效的 BOM");
    ErrorCode MD_BOM_DETAIL_NOT_EXISTS = new ErrorCode(1_040_111_100, "BOM 明细不存在");
    ErrorCode MD_BOM_DETAIL_PRODUCT_REQUIRED = new ErrorCode(1_040_111_101, "BOM 明镜子件不能为空");
    ErrorCode BOM_SUBSTITUTE_NOT_EXISTS = new ErrorCode(1_040_111_200, "BOM 替代料不存在");
    ErrorCode BOM_SUBSTITUTE_RATIO_INVALID = new ErrorCode(1_040_111_201, "BOM 替代料替代比例必须大于 0");

    // ========== MES 基础数据-ECN 工程变更单（1-040-112-000） ==========
    ErrorCode MD_ECN_ORDER_NOT_EXISTS = new ErrorCode(1_040_112_000, "ECN 工程变更单不存在");
    ErrorCode MD_ECN_ORDER_NO_DUPLICATE = new ErrorCode(1_040_112_001, "ECN 单号已存在：{}");
    ErrorCode MD_ECN_ORDER_STATUS_INVALID = new ErrorCode(1_040_112_002, "ECN 单据状态不正确，无法执行该操作");
    ErrorCode MD_ECN_ORDER_BOM_REQUIRED = new ErrorCode(1_040_112_003, "变更类型为修改/删除/替换时，原 BOM 编号不能为空");
    ErrorCode MD_ECN_ORDER_APPROVE_USER_REQUIRED = new ErrorCode(1_040_112_004, "审核 ECN 单据时审批人不能为空");
    ErrorCode MD_ECN_ORDER_ITEM_NOT_EXISTS = new ErrorCode(1_040_112_100, "ECN 变更明细不存在");

    // ========== MES 设备管理-SCADA 数据采集记录（1-040-309-000） ==========
    ErrorCode DV_DEVICE_DATA_RECORD_NOT_EXISTS = new ErrorCode(1_040_309_000, "设备数据采集记录不存在");
    ErrorCode DV_DEVICE_DATA_COLLECT_CONFIG_DISABLED = new ErrorCode(1_040_309_001, "设备 SCADA 配置未启用，无法采集");
    ErrorCode DV_DEVICE_DATA_COLLECT_CONFIG_NOT_EXISTS = new ErrorCode(1_040_309_002, "设备未配置 SCADA，无法采集");
    ErrorCode DV_DEVICE_DATA_COLLECT_FAIL = new ErrorCode(1_040_309_003, "设备数据采集失败：{}");

    // ========== MES 生产管理-PDA 报工（1-040-506-100） ==========
    ErrorCode PRO_PDA_FEEDBACK_WORK_ORDER_NOT_EXISTS = new ErrorCode(1_040_506_100, "工单编号不存在：{}");
    ErrorCode PRO_PDA_FEEDBACK_WORK_ORDER_NOT_CONFIRMED = new ErrorCode(1_040_506_101, "工单未确认，无法报工");
    ErrorCode PRO_PDA_FEEDBACK_TASK_NOT_EXISTS = new ErrorCode(1_040_506_102, "工单未关联生产任务，无法报工");
    ErrorCode PRO_PDA_FEEDBACK_QUANTITY_INVALID = new ErrorCode(1_040_506_103, "报工数量必须大于 0");
    ErrorCode PRO_PDA_FEEDBACK_MACHINERY_NOT_EXISTS = new ErrorCode(1_040_506_104, "设备编码不存在：{}");

    // ========== MES 能源消耗（1-040-507-000） ==========
    ErrorCode MES_ENERGY_CONSUMPTION_NOT_EXISTS = new ErrorCode(1_046_000_020, "能源消耗记录不存在");
