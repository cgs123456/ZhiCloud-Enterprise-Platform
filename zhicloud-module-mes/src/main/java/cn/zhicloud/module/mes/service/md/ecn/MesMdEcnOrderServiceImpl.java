...
import static cn.zhicloud.module.mes.enums.ErrorCodeConstants.MD_ECN_ORDER_BOM_REQUIRED;
import static cn.zhicloud.module.mes.enums.ErrorCodeConstants.MD_ECN_ORDER_NO_DUPLICATE;
import static cn.zhicloud.module.mes.enums.ErrorCodeConstants.MD_ECN_ORDER_NOT_EXISTS;
import static cn.zhicloud.module.mes.enums.ErrorCodeConstants.MD_ECN_ORDER_STATUS_INVALID;
...
public class MesMdEcnOrderServiceImpl implements MesMdEcnOrderService {
    ...
    private void saveItems(Long ecnOrderId, List<MesMdEcnOrderItemSaveReqVO> items) {
        ...
        List<MesMdEcnOrderItemDO> itemDOs = new ArrayList<>(items.size());
        ...
        ecnOrderItemMapper.insertBatch(itemDOs);
    }
