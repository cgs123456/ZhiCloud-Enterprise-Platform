package cn.zhicloud.module.mes.service.pro.mrp.gateway;
 ...
 *
 * <p>委托给 {@link MesProMrpService}，实现 zhicloud-module-erp 模块
 * 对 zhicloud-module-mes 模块 MRP 运算能力的反向调用（SPI 模式）。
 *
