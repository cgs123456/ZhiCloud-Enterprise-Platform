package cn.zhicloud.module.mes.controller.admin.pro.task;
...
import cn.zhicloud.module.mes.controller.admin.pro.task.vo.GanttDataRespVO;
import cn.zhicloud.module.mes.controller.admin.pro.task.vo.MesProTaskPageReqVO;
import cn.zhicloud.module.mes.controller.admin.pro.task.vo.MesProTaskRespVO;
...
public class MesProTaskController {
     ...
     * 计算进度 = 已生产 / 总量，返回 0~1
     */
    private double calcProgress(BigDecimal produced, BigDecimal total) {
        if (total == null || total.compareTo(BigDecimal.ZERO) <= 0 || produced == null) {
            return 0d;
        }
        return produced.divide(total, 6, RoundingMode.HALF_UP).doubleValue();
    }
