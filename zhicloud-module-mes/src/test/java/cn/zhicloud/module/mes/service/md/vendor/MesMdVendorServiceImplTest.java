package cn.zhicloud.module.mes.service.md.vendor;
...
import cn.zhicloud.module.mes.controller.admin.md.vendor.vo.MesMdVendorImportExcelVO;
import cn.zhicloud.module.mes.controller.admin.md.vendor.vo.MesMdVendorImportRespVO;
import cn.zhicloud.module.mes.controller.admin.md.vendor.vo.MesMdVendorPageReqVO;
import cn.zhicloud.module.mes.controller.admin.md.vendor.vo.MesMdVendorSaveReqVO;
import cn.zhicloud.module.mes.dal.dataobject.md.vendor.MesMdVendorDO;
import cn.zhicloud.module.mes.dal.mysql.md.vendor.MesMdVendorMapper;
import cn.zhicloud.module.mes.service.pro.workorder.MesProWorkOrderService;
import cn.zhicloud.module.mes.service.qc.iqc.MesQcIqcService;
import cn.zhicloud.module.mes.service.wm.arrivalnotice.MesWmArrivalNoticeService;
import cn.zhicloud.module.mes.service.wm.barcode.MesWmBarcodeService;
import cn.zhicloud.module.mes.service.wm.itemreceipt.MesWmItemReceiptService;
import cn.zhicloud.module.mes.service.wm.outsourceissue.MesWmOutsourceIssueService;
import cn.zhicloud.module.mes.service.wm.outsourcereceipt.MesWmOutsourceReceiptService;
import cn.zhicloud.module.mes.service.wm.returnvendor.MesWmReturnVendorService;
...
public class MesMdVendorServiceImplTest extends BaseDbUnitTest {
    ...
    private MesMdVendorDO buildVendor() {
        return new MesMdVendorDO().setId(100L).setCode("V001").setName("供应商A").setNickname("A")
                .setStatus(cn.zhicloud.framework.common.enums.CommonStatusEnum.ENABLE.getStatus());
    }
    ...
    public void testValidateVendorExistsAndEnable_disabled() {
        MesMdVendorDO disabled = buildVendor().setStatus(
                cn.zhicloud.framework.common.enums.CommonStatusEnum.DISABLE.getStatus());
