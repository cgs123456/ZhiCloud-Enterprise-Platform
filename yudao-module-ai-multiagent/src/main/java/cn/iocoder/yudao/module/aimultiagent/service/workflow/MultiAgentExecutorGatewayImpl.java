package cn.iocoder.yudao.module.aimultiagent.service.workflow;

import cn.iocoder.yudao.module.ai.service.workflow.MultiAgentExecutorGateway;
 ...
 *
 * <p>委托给 {@link MultiAgentExecuteService#execute}，实现 yudao-module-ai 模块
 * 对 yudao-module-ai-multiagent 模块能力的反向调用（SPI 模式）。
 *
