 ...
 *
 * <h3>子开关</h3>
 * <p>通过 {@code yudao.ai.security.pii-mask.mask-phone / mask-id-card / mask-email / mask-bank-card}
 * 独立控制每一类 PII 的脱敏开关。
 *
 * <h3>实现要点</h3>
 * <ol>
 ...
 */
@ControllerAdvice
@ConditionalOnProperty(prefix = "yudao.ai.security.pii-mask", name = "enabled", havingValue = "true")
...
public class PiiMaskConverter implements ResponseBodyAdvice<Object> {
    ...
    /**
     * Jackson ObjectMapper（yudao 默认注入，用于响应序列化）
     */
    @Autowired
