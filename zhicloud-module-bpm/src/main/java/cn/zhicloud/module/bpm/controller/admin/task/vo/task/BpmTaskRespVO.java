package cn.zhicloud.module.bpm.controller.admin.task.vo.task;
...
public class BpmTaskRespVO {
    ...
    @Schema(description = "任务名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "智云")
    private String name;
    ...
    @Schema(description = "签名", example = "https://www.zhicloud.cn/sign.png")
    private String signPicUrl;

    @Schema(description = "附件", example = "[https://test.zhicloud.zhicloud.cn/20260609/test.txt]")
    ...
    public static class ProcessInstance {
        ...
        @Schema(description = "流程实例名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "智云")
        private String name;
