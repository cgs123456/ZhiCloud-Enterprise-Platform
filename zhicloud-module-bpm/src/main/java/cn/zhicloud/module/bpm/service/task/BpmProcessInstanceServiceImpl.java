package cn.zhicloud.module.bpm.service.task;
...
import cn.zhicloud.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.zhicloud.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.zhicloud.module.bpm.controller.admin.task.vo.instance.*;
import cn.zhicloud.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.zhicloud.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.zhicloud.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.zhicloud.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.zhicloud.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.zhicloud.module.bpm.enums.ErrorCodeConstants;
import cn.zhicloud.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.zhicloud.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.zhicloud.module.bpm.enums.task.BpmAttachmentTypeEnum;
import cn.zhicloud.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.zhicloud.module.bpm.enums.task.BpmReasonEnum;
import cn.zhicloud.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.zhicloud.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.zhicloud.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.zhicloud.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.zhicloud.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.zhicloud.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.zhicloud.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.zhicloud.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.zhicloud.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.zhicloud.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.zhicloud.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.zhicloud.module.bpm.service.message.BpmMessageService;
...
import static cn.zhicloud.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.zhicloud.module.bpm.enums.ErrorCodeConstants.*;
import static cn.zhicloud.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.zhicloud.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/zhicloud-cloud/issues/ID1UYA
