package cn.zhicloud.module.crm.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode CLUE_NOT_OWNER = new ErrorCode(1_020_001_002, "线索【{}】放入公海失败，原因：线索不是公海数据");
    ErrorCode CLUE_OWNER_EXISTS = new ErrorCode(1_020_001_003, "线索【{}】已有负责人");
    ...
    // ========== 开票管理 1_020_014_000 ==========
    ErrorCode INVOICE_NOT_EXISTS = new ErrorCode(1_020_014_000, "开票不存在");
    ErrorCode INVOICE_NO_EXISTS = new ErrorCode(1_020_014_001, "生成开票序列号重复，请重试");
    ErrorCode INVOICE_UPDATE_FAIL_EDITING_PROHIBITED = new ErrorCode(1_020_014_002, "更新开票失败，原因：禁止编辑");
    ErrorCode INVOICE_SUBMIT_FAIL_NOT_DRAFT = new ErrorCode(1_020_014_003, "开票提交审核失败，原因：开票没处在未提交状态");
    ErrorCode INVOICE_UPDATE_AUDIT_STATUS_FAIL_NOT_PROCESS = new ErrorCode(1_020_014_004, "更新开票审批状态失败，原因：开票不是审核中状态");

    // ========== 拜访签到 1_020_015_000 ==========
    ErrorCode VISIT_RECORD_NOT_EXISTS = new ErrorCode(1_020_015_000, "拜访签到记录不存在");

    // ========== 销售订单 1_020_016_000 ==========
    ErrorCode SALE_ORDER_NOT_EXISTS = new ErrorCode(1_020_016_000, "销售订单不存在");
    ErrorCode SALE_ORDER_NO_EXISTS = new ErrorCode(1_020_016_001, "生成销售订单序列号重复，请重试");
    ErrorCode SALE_ORDER_UPDATE_FAIL_NOT_DRAFT = new ErrorCode(1_020_016_002, "销售订单更新失败，原因：订单不是草稿状态");
    ErrorCode SALE_ORDER_CONFIRM_FAIL_NOT_DRAFT = new ErrorCode(1_020_016_003, "销售订单确认失败，原因：订单不是草稿状态");
    ErrorCode SALE_ORDER_SUBMIT_FAIL_NOT_DRAFT = new ErrorCode(1_020_016_004, "销售订单提交审核失败，原因：订单没处在未提交状态");
    ErrorCode SALE_ORDER_DELETE_FAIL = new ErrorCode(1_020_016_005, "删除销售订单失败，原因：订单不是草稿状态");

    // ========== 线索渠道 1_020_017_000 ==========
    ErrorCode CLUE_CHANNEL_NOT_EXISTS = new ErrorCode(1_020_017_000, "线索渠道不存在");
    ErrorCode CLUE_CHANNEL_CODE_EXISTS = new ErrorCode(1_020_017_001, "渠道编码已存在");
    ErrorCode CLUE_CHANNEL_DISABLED = new ErrorCode(1_020_017_002, "线索渠道【{}】已停用");
    ErrorCode CLUE_CHANNEL_NOT_EXISTS_BY_CODE = new ErrorCode(1_020_017_003, "根据渠道编码【{}】找不到线索渠道");

    // ========== 合同电子签 1_020_018_000 ==========
    ErrorCode CONTRACT_ESIGN_INIT_FAIL = new ErrorCode(1_020_018_000, "发起电子签失败，原因：合同不存在");
    ErrorCode CONTRACT_ESIGN_TASK_NOT_EXISTS = new ErrorCode(1_020_018_001, "电子签任务不存在");
    ErrorCode CONTRACT_ESIGN_ALREADY_SIGNED = new ErrorCode(1_020_018_002, "合同已签署，无需重复发起");

    // ========== 售后工单 1_020_019_000 ==========
    ErrorCode WORK_ORDER_NOT_EXISTS = new ErrorCode(1_020_019_000, "售后工单不存在");
    ErrorCode WORK_ORDER_NO_EXISTS = new ErrorCode(1_020_019_001, "生成售后工单序列号重复，请重试");
    ErrorCode WORK_ORDER_ASSIGN_FAIL = new ErrorCode(1_020_019_002, "工单分配失败，原因：工单不是待分配状态");
    ErrorCode WORK_ORDER_RESOLVE_FAIL = new ErrorCode(1_020_019_003, "工单解决失败，原因：工单不是已分配或处理中状态");
    ErrorCode WORK_ORDER_CLOSE_FAIL = new ErrorCode(1_020_019_004, "工单关闭失败，原因：工单不是已解决状态");

    // ========== 乐观锁 1_020_020_000 ==========
    ErrorCode CRM_OPTIMISTIC_LOCK_FAIL = new ErrorCode(1_020_020_000, "数据更新失败，原因：数据已被其他人修改，请刷新后重试");
