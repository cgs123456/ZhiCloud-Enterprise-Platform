package cn.zhicloud.module.crm.controller.admin.customer.vo.customer;

import cn.zhicloud.framework.common.validation.InEnum;
import cn.zhicloud.framework.common.validation.Mobile;
import cn.zhicloud.framework.common.validation.Telephone;
import cn.zhicloud.framework.excel.core.annotations.DictFormat;
import cn.zhicloud.module.crm.enums.customer.CrmCustomerLevelEnum;
import cn.zhicloud.module.crm.framework.operatelog.core.CrmCustomerIndustryParseFunction;
import cn.zhicloud.module.crm.framework.operatelog.core.CrmCustomerLevelParseFunction;
import cn.zhicloud.module.crm.framework.operatelog.core.CrmCustomerSourceParseFunction;
import cn.zhicloud.module.crm.framework.operatelog.core.SysAreaParseFunction;
...
import static cn.zhicloud.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY;
...
public class CrmCustomerSaveReqVO {
    ...
    @Schema(description = "客户标签 ID 列表", example = "[1, 2]")
