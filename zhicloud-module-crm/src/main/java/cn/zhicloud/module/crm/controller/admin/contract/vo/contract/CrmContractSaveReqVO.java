package cn.zhicloud.module.crm.controller.admin.contract.vo.contract;

import cn.zhicloud.module.crm.framework.operatelog.core.CrmBusinessParseFunction;
import cn.zhicloud.module.crm.framework.operatelog.core.CrmContactParseFunction;
import cn.zhicloud.module.crm.framework.operatelog.core.CrmCustomerParseFunction;
import cn.zhicloud.module.crm.framework.operatelog.core.SysAdminUserParseFunction;
...
public class CrmContractSaveReqVO {
    ...
    @Schema(description = "合同附件 URL 列表", example = "[\"https://www.zhicloud.cn/1.pdf\"]")
