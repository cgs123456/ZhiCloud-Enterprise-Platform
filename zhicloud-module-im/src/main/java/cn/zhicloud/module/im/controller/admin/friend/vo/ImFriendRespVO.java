package cn.zhicloud.module.im.controller.admin.friend.vo;
...
public class ImFriendRespVO {
    ...
    @Schema(description = "好友昵称（实时聚合自 AdminUser）", example = "智云")
    private String nickname;

    @Schema(description = "好友昵称的拼音（小写无空格）", example = "zhicloud")
