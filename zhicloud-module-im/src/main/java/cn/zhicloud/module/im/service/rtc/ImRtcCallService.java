...
public interface ImRtcCallService {
     ...
     */
    void handleLiveKitEvent(cn.zhicloud.module.im.framework.rtc.core.LiveKitWebhookEventDTO event);
     ...
     * 实际超时阈值由后端 {@link cn.zhicloud.module.im.framework.config.ImProperties.Rtc#getInviteTimeoutMinutes()} 决定，
