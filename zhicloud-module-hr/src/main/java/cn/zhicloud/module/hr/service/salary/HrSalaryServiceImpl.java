...
import cn.zhicloud.module.hr.dal.mysql.salary.HrSalaryMapper;
import cn.zhicloud.module.hr.enums.salary.HrSalaryStatusEnum;
import cn.zhicloud.module.hr.service.attendance.HrAttendanceService;
...
import cn.zhicloud.module.hr.service.socialinsurance.HrSocialInsuranceService;
import cn.zhicloud.module.hr.util.HrIitCalculator;
...
public class HrSalaryServiceImpl implements HrSalaryService {
    ...
    public Long calculateMonthlySalary(HrSalaryCalculateReqVO reqVO) {
        ...
        BigDecimal netSalary = baseSalary.add(overtimePay).add(bonus)
                ...
                .setScale(2, RoundingMode.HALF_UP);
        // 9. 插入薪资记录（草稿状态）；并发兜底：唯一键冲突（uk_hr_salary_employee_month）转友好提示
