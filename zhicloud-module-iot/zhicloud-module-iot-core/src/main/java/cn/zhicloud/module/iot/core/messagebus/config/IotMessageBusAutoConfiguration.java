package cn.zhicloud.module.iot.core.messagebus.config;

import cn.zhicloud.framework.mq.redis.core.RedisMQTemplate;
import cn.zhicloud.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.zhicloud.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.zhicloud.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import cn.zhicloud.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import cn.zhicloud.module.iot.core.messagebus.core.IotMessageBus;
import cn.zhicloud.module.iot.core.messagebus.core.kafka.IotKafkaMessageBus;
import cn.zhicloud.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.zhicloud.module.iot.core.messagebus.core.rabbitmq.IotRabbitMQMessageBus;
import cn.zhicloud.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.zhicloud.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "zhicloud.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "zhicloud.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "zhicloud.iot.message-bus", name = "type", havingValue = "kafka")
    ...
    /**
     * 特殊：由于 ZhiCloudRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.zhicloud.framework.mq.redis.config.ZhiCloudRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "zhicloud.iot.message-bus", name = "type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "zhicloud.iot.message-bus", name = "type", havingValue = "rabbitmq")
