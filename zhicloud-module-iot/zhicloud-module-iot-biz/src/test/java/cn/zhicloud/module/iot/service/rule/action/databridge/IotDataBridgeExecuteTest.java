package cn.zhicloud.module.iot.service.rule.action.databridge;
...
import cn.zhicloud.module.iot.dal.dataobject.rule.config.*;
import cn.zhicloud.module.iot.service.rule.data.action.*;
...
public class IotDataBridgeExecuteTest extends BaseMockitoUnitTest {
    ...
    public void testHttpDataBridge() throws Exception {
        ...
        IotDataSinkHttpConfig config = new IotDataSinkHttpConfig()
                .setUrl("https://doc.zhicloud.cn/").setMethod(HttpMethod.GET.name());
