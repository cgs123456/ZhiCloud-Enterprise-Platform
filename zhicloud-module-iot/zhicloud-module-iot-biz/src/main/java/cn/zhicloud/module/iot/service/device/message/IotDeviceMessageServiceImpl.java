package cn.zhicloud.module.iot.service.device.message;
...
import cn.zhicloud.module.iot.controller.admin.device.vo.message.IotDeviceMessagePageReqVO;
import cn.zhicloud.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageReqVO;
import cn.zhicloud.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageSummaryByDateRespVO;
...
import cn.zhicloud.module.iot.core.mq.producer.IotDeviceMessageProducer;
import cn.zhicloud.module.iot.core.topic.IotDeviceIdentity;
import cn.zhicloud.module.iot.core.topic.event.IotDeviceEventPostReqDTO;
import cn.zhicloud.module.iot.core.topic.property.IotDevicePropertyPackPostReqDTO;
import cn.zhicloud.module.iot.core.topic.property.IotDevicePropertyPostReqDTO;
...
import cn.zhicloud.module.iot.dal.dataobject.device.IotDeviceMessageDO;
import cn.zhicloud.module.iot.dal.tdengine.IotDeviceMessageMapper;
...
import cn.zhicloud.module.iot.service.device.property.IotDevicePropertyService;
import cn.zhicloud.module.iot.service.ota.IotOtaTaskRecordService;
...
import static cn.zhicloud.module.iot.enums.ErrorCodeConstants.DEVICE_DOWNSTREAM_FAILED_SERVER_ID_NULL;
...
public class IotDeviceMessageServiceImpl implements IotDeviceMessageService {
    ...
    void createDeviceLogAsync(IotDeviceMessage message) {
        ...
        try {
            TDengineTableField.validateId(messageDO.getDeviceId(), "deviceId");
    ...
    public PageResult<IotDeviceMessageDO> getDeviceMessagePage(IotDeviceMessagePageReqVO pageReqVO) {
        try {
            TDengineTableField.validateId(pageReqVO.getDeviceId(), "reqVO.deviceId");
    ...
    public List<IotDeviceMessageDO> getDeviceMessageListByRequestIdsAndReply(Long deviceId, List<String> requestIds, Boolean reply) {
        ...
        TDengineTableField.validateId(deviceId, "deviceId");
