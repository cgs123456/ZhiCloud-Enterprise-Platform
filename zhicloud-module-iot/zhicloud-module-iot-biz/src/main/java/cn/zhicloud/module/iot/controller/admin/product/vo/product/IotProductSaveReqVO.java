package cn.zhicloud.module.iot.controller.admin.product.vo.product;
...
import cn.zhicloud.module.iot.enums.product.IotNetTypeEnum;
...
public class IotProductSaveReqVO {
    ...
    @Schema(description = "产品图标", example = "https://zhicloud.cn/1.svg")
    private String icon;

    @Schema(description = "产品图片", example = "https://zhicloud.cn/1.png")
