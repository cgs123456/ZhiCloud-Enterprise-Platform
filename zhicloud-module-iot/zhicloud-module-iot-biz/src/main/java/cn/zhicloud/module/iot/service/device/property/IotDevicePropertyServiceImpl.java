package cn.zhicloud.module.iot.service.device.property;
...
import cn.zhicloud.module.iot.controller.admin.device.vo.property.IotDevicePropertyHistoryListReqVO;
import cn.zhicloud.module.iot.controller.admin.device.vo.property.IotDevicePropertyRespVO;
import cn.zhicloud.module.iot.core.mq.message.IotDeviceMessage;
import cn.zhicloud.module.iot.dal.dataobject.device.IotDeviceDO;
import cn.zhicloud.module.iot.dal.dataobject.device.IotDevicePropertyDO;
import cn.zhicloud.module.iot.dal.dataobject.product.IotProductDO;
import cn.zhicloud.module.iot.dal.dataobject.thingmodel.IotThingModelDO;
import cn.zhicloud.module.iot.dal.dataobject.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import cn.zhicloud.module.iot.dal.redis.device.DevicePropertyRedisDAO;
import cn.zhicloud.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import cn.zhicloud.module.iot.dal.redis.device.DeviceServerIdRedisDAO;
import cn.zhicloud.module.iot.dal.tdengine.IotDevicePropertyMapper;
import cn.zhicloud.module.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import cn.zhicloud.module.iot.enums.thingmodel.IotThingModelTypeEnum;
import cn.zhicloud.module.iot.framework.tdengine.core.TDengineTableField;
import cn.zhicloud.module.iot.service.device.IotDeviceService;
import cn.zhicloud.module.iot.service.product.IotProductService;
import cn.zhicloud.module.iot.service.thingmodel.IotThingModelService;
...
import static cn.zhicloud.framework.common.util.collection.MapUtils.getBigDecimal;
...
public class IotDevicePropertyServiceImpl implements IotDevicePropertyService {
    ...
    public void defineDevicePropertyData(Long productId) {
        TDengineTableField.validateId(productId, "productId");
        // 1.1 查询产品和物模型
    ...
    private List<TDengineTableField> buildTableFieldList(List<IotThingModelDO> thingModels) {
        return convertList(thingModels, thingModel -> {
            TDengineTableField.validateIdentifier(thingModel.getIdentifier());
    ...
    public void saveDeviceProperty(IotDeviceDO device, IotDeviceMessage message) {
        ...
        if (CollUtil.isEmpty(properties)) {
            ...
            // 2.1 保存设备属性【数据】（先校验 ${} 拼接安全）
            TDengineTableField.validateId(device.getId(), "device.id");
            TDengineTableField.validateId(device.getProductId(), "device.productId");
            properties.keySet().forEach(TDengineTableField::validateIdentifier);
    ...
    public List<IotDevicePropertyRespVO> getHistoryDevicePropertyList(IotDevicePropertyHistoryListReqVO listReqVO) {
        TDengineTableField.validateId(listReqVO.getDeviceId(), "reqVO.deviceId");
        TDengineTableField.validateIdentifier(listReqVO.getIdentifier());
        try {
