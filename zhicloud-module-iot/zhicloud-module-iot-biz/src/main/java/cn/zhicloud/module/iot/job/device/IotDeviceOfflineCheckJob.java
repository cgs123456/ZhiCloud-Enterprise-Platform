package cn.zhicloud.module.iot.job.device;
...
import cn.zhicloud.module.iot.framework.iot.config.ZhiCloudIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private ZhiCloudIotProperties iotProperties;
