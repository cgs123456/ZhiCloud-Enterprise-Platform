package cn.zhicloud.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.zhicloud.module.iot.core.biz.IotDeviceCommonApi;
import cn.zhicloud.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.zhicloud.module.iot.core.biz.dto.IotDeviceRespDTO;
import cn.zhicloud.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import cn.zhicloud.module.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.zhicloud.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.zhicloud.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import cn.zhicloud.module.iot.core.mq.message.IotDeviceMessage;
import cn.zhicloud.module.iot.core.topic.IotDeviceIdentity;
import cn.zhicloud.module.iot.core.util.IotDeviceAuthUtils;
import cn.zhicloud.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.zhicloud.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.zhicloud.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.zhicloud.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.zhicloud.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.zhicloud.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.zhicloud.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.zhicloud.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.zhicloud.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.zhicloud.module.iot.gateway.service.device.IotDeviceService;
import cn.zhicloud.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.zhicloud.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.zhicloud.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.zhicloud.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
