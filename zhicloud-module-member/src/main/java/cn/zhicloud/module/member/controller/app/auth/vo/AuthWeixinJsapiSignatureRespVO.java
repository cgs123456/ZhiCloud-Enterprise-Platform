package cn.zhicloud.module.member.controller.app.auth.vo;
...
public class AuthWeixinJsapiSignatureRespVO {
    ...
    @Schema(description = "URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zhicloud.cn")
    private String url;
