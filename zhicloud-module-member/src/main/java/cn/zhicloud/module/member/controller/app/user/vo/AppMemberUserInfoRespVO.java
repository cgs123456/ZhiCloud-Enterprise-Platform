package cn.zhicloud.module.member.controller.app.user.vo;
...
public class AppMemberUserInfoRespVO {
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zhicloud.cn/xxx.png")
    private String avatar;

    @Schema(description = "用户手机号", requiredMode = Schema.RequiredMode.REQUIRED, example = "15601691300")
    private String mobile;

    @Schema(description = "邮箱", example = "member@zhicloud.cn")
    ...
    public static class Level {
        ...
        @Schema(description = "等级图标", example = "https://www.zhicloud.cn/zhicloud.jpg")
        private String icon;
