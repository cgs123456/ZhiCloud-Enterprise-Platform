...
public class CrmVisitRecordRespVO {
    ...
    @Schema(description = "客户名称", example = "芋道客户")
    private String customerName;

    @Schema(description = "联系人编号", example = "2")
    private Long contactId;
    @Schema(description = "联系人名称", example = "芋道联系人")
    private String contactName;

    @Schema(description = "负责人的用户编号", example = "25682")
    private Long ownerUserId;
    @Schema(description = "负责人名字", example = "芋道")
    ...
    @Schema(description = "图片 URL 列表", example = "[\"https://www.iocoder.cn/1.png\"]")
    private List<String> picUrls;

    @Schema(description = "附件 URL 列表", example = "[\"https://www.iocoder.cn/1.pdf\"]")
    ...
    @Schema(description = "创建人名字", example = "芋道")
