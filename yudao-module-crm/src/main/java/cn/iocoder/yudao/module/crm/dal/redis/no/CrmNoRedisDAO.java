...
public class CrmNoRedisDAO {
    ...
    /**
     * 开票 {@link cn.iocoder.yudao.module.crm.dal.dataobject.invoice.CrmInvoiceDO}
     */
    public static final String INVOICE_PREFIX = "FP";

    /**
     * 销售订单 {@link cn.iocoder.yudao.module.crm.dal.dataobject.salesorder.CrmSaleOrderDO}
     */
    public static final String SALE_ORDER_NO_PREFIX = "SO";

    /**
     * 售后工单 {@link cn.iocoder.yudao.module.crm.dal.dataobject.servicecloud.CrmWorkOrderDO}
     */
