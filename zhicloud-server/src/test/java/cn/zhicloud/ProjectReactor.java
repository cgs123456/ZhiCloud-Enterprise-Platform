...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.zhicloud";
    private static final String ARTIFACT_ID = "zhicloud";
    private static final String PACKAGE_NAME = "cn.zhicloud";
    private static final String TITLE = "智云管理系统";
