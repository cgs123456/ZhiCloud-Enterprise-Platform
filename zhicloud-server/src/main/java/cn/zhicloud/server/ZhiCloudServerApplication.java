 ...
 * 项目的启动类
 *
 * 如果你碰到启动的问题，请认真阅读 https://doc.zhicloud.cn/quick-start/ 文章
 * 如果你碰到启动的问题，请认真阅读 https://doc.zhicloud.cn/quick-start/ 文章
 * 如果你碰到启动的问题，请认真阅读 https://doc.zhicloud.cn/quick-start/ 文章
 *
 * @author 智云
 */
@SuppressWarnings("SpringComponentScan") // 忽略 IDEA 无法识别 ${zhicloud.info.base-package}
// 排除多个 EmbeddingModel 自动配置 + PgVectorStore 自动配置（多 Embedding bean 冲突，由 AiragConfiguration 自定义）
@SpringBootApplication(
        scanBasePackages = {"${zhicloud.info.base-package}.server", "${zhicloud.info.base-package}.module"},
        exclude = {
...
public class ZhiCloudServerApplication {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(ZhiCloudServerApplication.class, args);
//        new SpringApplicationBuilder(ZhiCloudServerApplication.class)
