-- ============================================================
-- V83: HR 基础表（部门/职位/员工/考勤/薪资/绩效）+ HR 字典种子数据
--
-- 来源：sql/mysql/hr.sql。修复全新库部署缺陷：HR 模块启用（V48-V51 仅含
--       合同/请假/社保/招聘），但基础表此前只能手工执行 hr.sql，
--       导致 V84 的薪资唯一索引在全新库因 hr_salary 不存在而失败。
-- 幂等：CREATE TABLE IF NOT EXISTS；INSERT IGNORE（依赖唯一键去重）。
-- 存量库：表已存在 -> no-op；全新库：完整建表 + 字典种子。
-- ============================================================
...
VALUES ('HR 性别', 'hr_gender', 0, 'admin', NOW(), 'admin', NOW(), 0, 'HR 员工性别字典');
...
VALUES
(1, '男', '10', 'hr_gender', 0, 'primary', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(2, '女', '20', 'hr_gender', 0, 'danger',  '', '', 'admin', NOW(), 'admin', NOW(), 0);

-- HR 员工状态字典
INSERT IGNORE INTO system_dict_type (name, type, status, creator, create_time, updater, update_time, deleted, remark)
VALUES ('HR 员工状态', 'hr_employee_status', 0, 'admin', NOW(), 'admin', NOW(), 0, 'HR 员工状态字典');
INSERT IGNORE INTO system_dict_data (sort, label, value, dict_type, status, color_type, css_class, remark, creator, create_time, updater, update_time, deleted)
VALUES
(1, '在职', '10', 'hr_employee_status', 0, 'success', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(2, '离职', '20', 'hr_employee_status', 0, 'danger',  '', '', 'admin', NOW(), 'admin', NOW(), 0),
(3, '停薪', '30', 'hr_employee_status', 0, 'warning', '', '', 'admin', NOW(), 'admin', NOW(), 0);

-- HR 用工类型字典
INSERT IGNORE INTO system_dict_type (name, type, status, creator, create_time, updater, update_time, deleted, remark)
VALUES ('HR 用工类型', 'hr_employment_type', 0, 'admin', NOW(), 'admin', NOW(), 0, 'HR 用工类型字典');
INSERT IGNORE INTO system_dict_data (sort, label, value, dict_type, status, color_type, css_class, remark, creator, create_time, updater, update_time, deleted)
VALUES
(1, '全职', '10', 'hr_employment_type', 0, 'primary', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(2, '兼职', '20', 'hr_employment_type', 0, 'success', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(3, '实习', '30', 'hr_employment_type', 0, 'warning', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(4, '外包', '40', 'hr_employment_type', 0, 'info',    '', '', 'admin', NOW(), 'admin', NOW(), 0);

-- HR 职位级别字典
INSERT IGNORE INTO system_dict_type (name, type, status, creator, create_time, updater, update_time, deleted, remark)
VALUES ('HR 职位级别', 'hr_position_level', 0, 'admin', NOW(), 'admin', NOW(), 0, 'HR 职位级别字典');
INSERT IGNORE INTO system_dict_data (sort, label, value, dict_type, status, color_type, css_class, remark, creator, create_time, updater, update_time, deleted)
VALUES
(1, '初级', '10', 'hr_position_level', 0, 'info',    '', '', 'admin', NOW(), 'admin', NOW(), 0),
(2, '中级', '20', 'hr_position_level', 0, 'primary', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(3, '高级', '30', 'hr_position_level', 0, 'success', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(4, '专家', '40', 'hr_position_level', 0, 'warning', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(5, '管理', '50', 'hr_position_level', 0, 'danger',  '', '', 'admin', NOW(), 'admin', NOW(), 0);

-- HR 考勤状态字典
INSERT IGNORE INTO system_dict_type (name, type, status, creator, create_time, updater, update_time, deleted, remark)
VALUES ('HR 考勤状态', 'hr_attendance_status', 0, 'admin', NOW(), 'admin', NOW(), 0, 'HR 考勤状态字典');
INSERT IGNORE INTO system_dict_data (sort, label, value, dict_type, status, color_type, css_class, remark, creator, create_time, updater, update_time, deleted)
VALUES
(1, '正常', '10', 'hr_attendance_status', 0, 'success', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(2, '迟到', '20', 'hr_attendance_status', 0, 'warning', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(3, '早退', '30', 'hr_attendance_status', 0, 'warning', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(4, '缺勤', '40', 'hr_attendance_status', 0, 'danger',  '', '', 'admin', NOW(), 'admin', NOW(), 0),
(5, '加班', '50', 'hr_attendance_status', 0, 'primary', '', '', 'admin', NOW(), 'admin', NOW(), 0);

-- HR 薪资状态字典
INSERT IGNORE INTO system_dict_type (name, type, status, creator, create_time, updater, update_time, deleted, remark)
VALUES ('HR 薪资状态', 'hr_salary_status', 0, 'admin', NOW(), 'admin', NOW(), 0, 'HR 薪资状态字典');
INSERT IGNORE INTO system_dict_data (sort, label, value, dict_type, status, color_type, css_class, remark, creator, create_time, updater, update_time, deleted)
VALUES
(1, '草稿',   '10', 'hr_salary_status', 0, 'info',    '', '', 'admin', NOW(), 'admin', NOW(), 0),
(2, '已审核', '20', 'hr_salary_status', 0, 'primary', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(3, '已发放', '30', 'hr_salary_status', 0, 'success', '', '', 'admin', NOW(), 'admin', NOW(), 0);

-- HR 绩效等级字典
INSERT IGNORE INTO system_dict_type (name, type, status, creator, create_time, updater, update_time, deleted, remark)
VALUES ('HR 绩效等级', 'hr_performance_grade', 0, 'admin', NOW(), 'admin', NOW(), 0, 'HR 绩效等级字典');
INSERT IGNORE INTO system_dict_data (sort, label, value, dict_type, status, color_type, css_class, remark, creator, create_time, updater, update_time, deleted)
VALUES
(1, 'A', '10', 'hr_performance_grade', 0, 'success', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(2, 'B', '20', 'hr_performance_grade', 0, 'primary', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(3, 'C', '30', 'hr_performance_grade', 0, 'warning', '', '', 'admin', NOW(), 'admin', NOW(), 0),
(4, 'D', '40', 'hr_performance_grade', 0, 'danger',  '', '', 'admin', NOW(), 'admin', NOW(), 0);