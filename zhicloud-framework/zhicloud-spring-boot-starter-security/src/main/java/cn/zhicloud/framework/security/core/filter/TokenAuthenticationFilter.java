package cn.zhicloud.framework.security.core.filter;
...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    private LoginUser mockLoginUser(HttpServletRequest request, String token, Integer userType) {
        ...
        if (StrUtil.isBlank(securityProperties.getMockSecret())) {
            throw new ServiceException(GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR, "mock-enable=true 时必须显式配置 mock-secret，请检查 zhicloud.security.mock-secret 配置");
        }
        // 必须以 mockSecret 开头
