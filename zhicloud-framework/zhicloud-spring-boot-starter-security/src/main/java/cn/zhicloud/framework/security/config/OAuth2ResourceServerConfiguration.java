...
import cn.zhicloud.framework.security.core.converter.JwtToLoginUserConverter;
 ...
 *
 * 当 {@code zhicloud.security.oauth2.enabled=true} 时生效，
...
@ConditionalOnProperty(prefix = "zhicloud.security.oauth2", name = "enabled", havingValue = "true")
public class OAuth2ResourceServerConfiguration {
    ...
    public JwtDecoder jwtDecoder() {
        ...
        throw new ServiceException(GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR, "OAuth2 Resource Server 启用时，必须配置 zhicloud.security.oauth2.jwk-set-uri 或 issuer-uri");
    }
     ...
     * 该 Bean 类型不含 OAuth2 类，可安全注入到 {@link ZhiCloudWebSecurityConfigurerAdapter}。
     */
    @Bean
