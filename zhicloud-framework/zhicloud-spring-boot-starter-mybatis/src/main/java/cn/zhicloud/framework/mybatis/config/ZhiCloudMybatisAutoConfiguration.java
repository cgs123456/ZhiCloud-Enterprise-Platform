package cn.zhicloud.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.zhicloud.framework.common.util.json.JsonUtils;
import cn.zhicloud.framework.mybatis.core.handler.DefaultDBFieldHandler;
import cn.zhicloud.framework.mybatis.core.intercept.PageSizeNoneLimitInnerInterceptor;
...
@MapperScan(value = "${zhicloud.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class ZhiCloudMybatisAutoConfiguration {
