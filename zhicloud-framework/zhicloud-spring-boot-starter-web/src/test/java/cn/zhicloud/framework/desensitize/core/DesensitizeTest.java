package cn.zhicloud.framework.desensitize.core;

import cn.zhicloud.framework.common.util.json.JsonUtils;
import cn.zhicloud.framework.desensitize.core.annotation.Address;
import cn.zhicloud.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.zhicloud.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.zhicloud.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("智云科技");
        ...
        desensitizeDemo.setRegex("你好，我是智云");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("智云");

        // 调用
        DesensitizeDemo d = JsonUtils.parseObject(JsonUtils.toJsonString(desensitizeDemo), DesensitizeDemo.class);
        // 断言
        assertNotNull(d);
        assertEquals("智***", d.getNickname());
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "智云", replacer = "*")
