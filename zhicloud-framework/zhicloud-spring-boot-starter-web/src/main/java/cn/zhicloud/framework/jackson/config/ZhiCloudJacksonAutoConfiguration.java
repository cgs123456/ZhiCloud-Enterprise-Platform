package cn.zhicloud.framework.jackson.config;

import cn.zhicloud.framework.common.util.json.JsonUtils;
import cn.zhicloud.framework.common.util.json.databind.NumberSerializer;
import cn.zhicloud.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import cn.zhicloud.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class ZhiCloudJacksonAutoConfiguration {
