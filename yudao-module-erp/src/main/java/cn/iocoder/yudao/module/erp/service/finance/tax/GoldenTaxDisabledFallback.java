...
import static cn.iocoder.yudao.module.erp.enums.ErrorCodeConstants.GOLDEN_TAX_NOT_ENABLED;

/**
 * 金税四期接口默认回退实现（禁用态）
 *
 * <p>当 {@code yudao.erp.golden-tax.enabled} 未启用（默认 false 或缺省）时加载本实现。
 * 所有方法抛出 {@link cn.iocoder.yudao.framework.common.exception.ServiceException}，
...
@Slf4j
@Component
@ConditionalOnProperty(name = "yudao.erp.golden-tax.enabled", havingValue = "false", matchIfMissing = true)
