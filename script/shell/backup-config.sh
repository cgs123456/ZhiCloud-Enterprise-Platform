...
# ===== 本地备份目录与保留策略 =====
LOCAL_BACKUP_DIR=/data/backup/zhicloud
...
REMOTE_RSYNC_PATH=/data/backup/zhicloud
REMOTE_RSYNC_PORT=22
REMOTE_RETENTION_DAYS=30

# ----- 模式 2：S3 兼容存储 -----
S3_ENABLED=false
S3_BUCKET=zhicloud-backup
...
# ===== 日志目录 =====
LOG_DIR=/var/log/zhicloud-backup
...
# 容灾演练结果输出目录
DRILL_REPORT_DIR=/var/log/zhicloud-drill
