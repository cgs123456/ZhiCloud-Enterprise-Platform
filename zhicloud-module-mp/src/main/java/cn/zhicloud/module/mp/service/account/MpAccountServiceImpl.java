package cn.zhicloud.module.mp.service.account;
...
import cn.zhicloud.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.zhicloud.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.zhicloud.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.zhicloud.module.mp.convert.account.MpAccountConvert;
import cn.zhicloud.module.mp.dal.dataobject.account.MpAccountDO;
import cn.zhicloud.module.mp.dal.mysql.account.MpAccountMapper;
import cn.zhicloud.module.mp.enums.ErrorCodeConstants;
...
import static cn.zhicloud.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 zhicloud-module-mp - 表结构未导入][参考 https://doc.zhicloud.cn/mp/build/ 开启]");
            }
