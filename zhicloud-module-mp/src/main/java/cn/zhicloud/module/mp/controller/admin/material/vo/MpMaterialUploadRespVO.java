package cn.zhicloud.module.mp.controller.admin.material.vo;
...
public class MpMaterialUploadRespVO {
    ...
    @Schema(description = "素材的 URL", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.zhicloud.cn/1.png")
    private String url;
