...
import cn.iocoder.yudao.module.mes.dal.mysql.dv.scada.MesDvDeviceDataRecordMapper;
...
import static cn.iocoder.yudao.module.mes.enums.ErrorCodeConstants.DV_DEVICE_DATA_RECORD_NOT_EXISTS;
...
public class MesDvDeviceDataRecordServiceImpl implements MesDvDeviceDataRecordService {
    ...
    public int saveRecords(List<MesDvDeviceDataRecordDO> records) {
        ...
        int count = 0;
        for (MesDvDeviceDataRecordDO record : records) {
