...
import cn.iocoder.yudao.module.mes.dal.mysql.pro.aps.MesProApsPlanMapper;
...
import cn.iocoder.yudao.module.mes.service.pro.aps.strategy.ApsContext;
import cn.iocoder.yudao.module.mes.service.pro.aps.strategy.ApsResult;
import cn.iocoder.yudao.module.mes.service.pro.aps.strategy.ApsStrategy;
...
import static cn.iocoder.yudao.module.mes.enums.ErrorCodeConstants.PRO_APS_PLAN_CAPACITY_EXCEEDED;
import static cn.iocoder.yudao.module.mes.enums.ErrorCodeConstants.PRO_APS_PLAN_DATE_RANGE_INVALID;
import static cn.iocoder.yudao.module.mes.enums.ErrorCodeConstants.PRO_APS_PLAN_NOT_CONFIRMED;
import static cn.iocoder.yudao.module.mes.enums.ErrorCodeConstants.PRO_APS_PLAN_NOT_EXISTS;
import static cn.iocoder.yudao.module.mes.enums.ErrorCodeConstants.PRO_APS_PLAN_RESCHEDULE_TIME_INVALID;
import static cn.iocoder.yudao.module.mes.enums.ErrorCodeConstants.PRO_APS_PLAN_WORK_ORDER_DUPLICATE;
import static cn.iocoder.yudao.module.mes.enums.ErrorCodeConstants.PRO_APS_PLAN_WORK_ORDER_EMPTY;
import static cn.iocoder.yudao.module.mes.enums.ErrorCodeConstants.PRO_APS_PLAN_WORK_ORDER_STATUS_INVALID;
import static cn.iocoder.yudao.module.mes.enums.ErrorCodeConstants.PRO_APS_PLAN_WORKSTATION_EMPTY;
...
public class MesProApsServiceImpl implements MesProApsService {
    ...
    /**
     * 排产算法配置（GREEDY / TOC_DBR / GENETIC），见 application.yaml: yudao.mes.aps.algorithm
     */
    @Value("${yudao.mes.aps.algorithm:GREEDY}")
    ...
    public List<MesProApsPlanDO> generateSchedule(MesProApsGenerateReqVO reqVO) {
        ...
        for (MesProWorkOrderDO workOrder : workOrders) {
            if (!cn.iocoder.yudao.module.mes.enums.pro.MesProWorkOrderStatusEnum.CONFIRMED.getStatus()
        ...
        for (MesMdWorkstationDO ws : workstations) {
            ...
            List<MesProApsPlanDO> plans = apsPlanMapper.selectListByWorkstationAndTimeRange(
                    ws.getId(), reqVO.getStartDate(), reqVO.getEndDate());
            if (CollUtil.isNotEmpty(plans)) {
                for (MesProApsPlanDO p : plans) {
        ...
        // 7. 落库：统一回填 planNo + 状态后持久化（计划由策略生成，planNo 在此统一分配）
