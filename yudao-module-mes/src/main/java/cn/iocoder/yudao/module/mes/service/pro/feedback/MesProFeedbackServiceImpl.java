...
import cn.iocoder.yudao.module.mes.listener.MesProFeedbackApprovedEvent;
...
public class MesProFeedbackServiceImpl implements MesProFeedbackService {
    ...
    public Long pdaSubmitFeedback(MesPdaFeedbackSubmitReqVO reqVO) {
        ...
        MesProTaskDO task = tasks.stream()
                ...
                .filter(t -> !ObjUtil.equal(t.getStatus(), cn.iocoder.yudao.module.mes.enums.pro.MesProTaskStatusEnum.FINISHED.getStatus()))
                .findFirst()
                .orElse(null);
        if (task == null) {
