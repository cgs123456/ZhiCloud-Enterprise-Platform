package cn.zhicloud.module.wms.controller.admin.order.check.vo.order;
...
public class WmsCheckOrderRespVO {
    ...
    @Schema(description = "盘点类型", example = "2")
    @ExcelProperty("盘点类型")
    private Integer checkType;

    @Schema(description = "循环盘点周期天数", example = "30")
    ...
    @Schema(description = "更新者名称", example = "智云")
